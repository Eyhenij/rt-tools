 ...
 *
 * Кадра у списка нет намеренно. Время последнего входа стоит колонкой, ширину столбцов таблица
 * раскладывает по содержимому, а у записи самого набора это время — минута прогона: закрепить его
 * нечем, и кадр расходился бы сам с собой каждый день. Правки над людьми — заведение, новый
 * пароль, отключение — проверяет соседний набор панели, идущий после этого.
 */
