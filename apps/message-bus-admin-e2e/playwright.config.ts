...
export default defineConfig({
    ...
    webServer: {
        ...
        // Десять минут, а не пять: подъём начинается со сборок, и на холодном кэше в них входит
        // весь кит. Пяти минут хватало ровно до первого прогона после вливания главной ветки —
        // там кэш пуст целиком, и стенд не успевал ответить.
        timeout: 600_000,
        stdout: 'pipe',
        stderr: 'pipe',
    },
