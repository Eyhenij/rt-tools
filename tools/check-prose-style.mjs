#!/usr/bin/env node
// rt-kit v0.25.0 · checks/check-prose-style.mjs · 401a9a37b909 · правится надстройкой, не здесь
/**
 ...
 *
 * Дерево дописывает свою половину таблицы «Not written here» надстройкой словаря, и без этого её не
