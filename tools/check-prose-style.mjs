#!/usr/bin/env node
// rt-kit v0.9.1 · checks/check-prose-style.mjs · b28506f15316 · правится надстройкой, не здесь
/**
...
const MARKS = [
    ...
    // Множественного числа здесь нет намеренно: «данные» — законное существительное, и стоит
    // оно обязательным заголовком раздела в каждом спеке. Отличить его от местоимения
    // образцом нечем, а находка на обязательном заголовке отбивает написание спека целиком.
