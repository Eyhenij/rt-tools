#!/usr/bin/env node
// rt-kit v0.8.0 · checks/check-reuse.mjs · ead586331ec8 · правится надстройкой, не здесь
/**
 ...
 * обнулял бы сводку. Второе: маркер `native-ok` снимает свою строку, а не весь файл.
 *
