...
const secondEntryDir = path.resolve(__dirname, '../projects/ui-kit-v2/src/rich-editor/lib/components');
...
const files = [...walk(componentsDir), ...(fs.existsSync(secondEntryDir) ? walk(secondEntryDir) : [])];
