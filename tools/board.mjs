#!/usr/bin/env node
// rt-kit v0.27.0 · checks/board.github.mjs · 608ab28dc91e · правится надстройкой, не здесь
/**
 ...
 *
 * No network or no token is an inability to check, not a discrepancy: the functions return `null`,
 * the command mode prints `{"offline":true}`.
 */
