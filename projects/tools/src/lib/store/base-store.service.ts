...
import { isNil, PlatformService, WINDOW } from '../util';
...
> {
    ...
    #shouldEnableDevTools(config?: IStoreConfig): boolean {
        ...
        return this.#platformService.isPlatformBrowser && typeof !isNil(this.#windowRef) && !!this.#windowRef.__REDUX_DEVTOOLS_EXTENSION__;
    }
