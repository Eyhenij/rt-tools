...
# --- SC-AK-1153 — ветка задачи без своей папки названа ------------------------------------
...
report "SC-AK-1153 — ветка задачи без папки названа" "$(bf_says 'RT-700-task: the task folder never travelled')" 1

# --- SC-AK-1154 — ветка эпика папки задачи не требует -------------------------------------
...
report "SC-AK-1154 — ветка эпика папки не требует" "$(bf_says 'RT-800-epic: the task folder never travelled')" 0

# --- SC-AK-1127 — ветка задачи со своей папкой расхождением не считается -------------------
