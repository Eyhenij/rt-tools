...
# --- SC-AK-1125 — ветка задачи без своей папки названа ------------------------------------
...
report "SC-AK-1125 — ветка задачи без папки названа" "$(bf_says 'RT-700-task: the task folder never travelled')" 1

# --- SC-AK-1126 — ветка эпика папки задачи не требует -------------------------------------
...
report "SC-AK-1126 — ветка эпика папки не требует" "$(bf_says 'RT-800-epic: the task folder never travelled')" 0
