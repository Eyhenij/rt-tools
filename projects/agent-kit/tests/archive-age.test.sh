...
check_says "SC-AK-869 — проверка при этом зелёная" 'ни одна не перестояла' "есть"

# Восемь суток и час: вышел и запас.
record_aged RT-2-late $((8 * 24 + 1))
check_says "SC-AK-870 — запись в 8 суток и час проверка называет" 'RT-2-late.*8 суток при сроке в 7 и запасе в 1' "есть"
check_says "SC-AK-870 — семисуточную по-прежнему нет" 'RT-1-week' "нет"
prune_says "SC-AK-870 — чистка снимает обе" 'перестояло 2 из 2' "есть"
