...
# --- SC-AK-238 и SC-AK-239 — вердикт вместо адреса ------------------------------------------
#
...
report "SC-AK-238 — вердикт с причиной принят" "$(specs_says 'пустая привязка')" 0

verdict_row '**Не исполняется.**'
report "SC-AK-239 — вердикт без причины не принят" "$(specs_says 'пустая привязка')" 1
