# The changelog — releases 0.9.0 … 0.17.0

The old part of the journal, carried out of `projects/agent-kit/CHANGELOG.md`: that one outgrew the document length limit,
