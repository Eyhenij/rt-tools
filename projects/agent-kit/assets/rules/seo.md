...
Что отдаёт корень локали — единственную запись или список, — правило не утверждает: это
состояние дерева, и живёт оно в компаньоне рядом. Развилка от этого не исчезает: там, где
список появляется, канонический адрес корня пересматривается; это `Q-SV-1` в законе.
