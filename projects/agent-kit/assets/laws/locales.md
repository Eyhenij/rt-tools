...
- **Q-L-1.** Что показывать гостю, чей перевод объекта устарел после правки владельца, но
  ещё не перезаписан из-за отказа провайдера? Сейчас видно прежний текст, признака
  устаревания у страницы нет. Заведён 2026-07-31.
- **Q-L-2.** Как выбирается локаль гостю, пришедшему на корень сайта: сегодня это адрес, а
  не язык браузера. Решение изменит поведение первой страницы и набор адресов, которые
  попадают в кэш. Заведён 2026-07-31.
