...
- **Q-A-1.** Что видит владелец, у которого право отобрали посреди сессии? Токен живёт со
  своими правами до истечения, и раздел останется доступным до перевхода. Заведён
  2026-07-31.
- **Q-A-2.** Как владелец меняет свой пароль? Сегодня пароль задаётся при заведении учётной
  записи и из интерфейса не меняется: ни экрана смены, ни процедуры, ни восстановления
  забытого. Решение потребует процедуры смены и правила о подтверждении прежним паролем.
  Заведён 2026-07-31, уточнён 2026-08-01 по коду домена `auth`.
