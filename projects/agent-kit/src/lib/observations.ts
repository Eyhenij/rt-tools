 ...
 *
 * `guards` — имена гардов, разложенных в это дерево. Гардом здесь считается тот, кто заявил своё
 * имя для наблюдений: хук без заявки в наблюдениях не появится ни при каком отрезке, и молчащим
 * он назывался бы неверно — он молчит не потому, что не понадобился.
 *
