...
describe('холодная часть правила', (): void => {
    it('SC-AK-510 — холодная часть ложится третьим файлом в каталог своего правила', (): void => {
    ...
    it('SC-AK-511 — холодная часть за имя файла с самим правилом не спорит', (): void => {
