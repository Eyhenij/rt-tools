 ...
 *
 * Ресурс, с которым сверяется цитата, берётся из дерева пакета: выдуманный набор сказал бы, что
...
const withQuote: string = [
    ...
    '- **ближайшее:** «Класс ставится директивой, а не строкой в атрибуте.» — про имя, не про значение',
    '',
    '> Текст правки.',
].join('\n');
