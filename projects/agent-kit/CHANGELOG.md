...
- **rt:agent-kit:** гард обходных путей судит и браузер, поднятый из кода ([0cad5c2](https://github.com/Eyhenij/rt-tools/commit/0cad5c231c61eb36a6834bc3e6966f27470773db))
- **rt:agent-kit:** гард экзамена не запирает дерево и судит запись оболочкой ([dbc900c](https://github.com/Eyhenij/rt-tools/commit/dbc900c7832840e1bd712c8e8874fcccc000299c))
- **rt:agent-kit:** номер заголовка вынимается формой, а цитата утверждением не считается ([ca30118](https://github.com/Eyhenij/rt-tools/commit/ca301184fbfe1882cb7ca8051233b803394f71df))
- **rt:agent-kit:** строка проверки эпиков переписана так, чтобы форматтер её не двигал ([2c30f8b](https://github.com/Eyhenij/rt-tools/commit/2c30f8bf04bca166dbae99fa3584f41de82d97f4))
- **rt:message-bus:** гард судит отдачу работы, а не взятие записи груза ([39d1a17](https://github.com/Eyhenij/rt-tools/commit/39d1a17e1859688e3c8569b4edc9f26607281476))

### Features

- **rt:agent-kit:** выкушенная из набора гейта проверка называется сверкой ([b3841db](https://github.com/Eyhenij/rt-tools/commit/b3841dbd9afb6e6eb2b6285ecf5a84d24885c386))
- **rt:agent-kit:** гард ожидания ловит объявленный свой шаг, за которым ничего не сделано ([99d5d07](https://github.com/Eyhenij/rt-tools/commit/99d5d0755b6271c2237078e271e5d00573abc010))
- **rt:agent-kit:** гейт судит то, что команда пишет, а не то, что она называет ([a5d6788](https://github.com/Eyhenij/rt-tools/commit/a5d678881ccef6736ab649922a75ff6263061e44))
- **rt:agent-kit:** груз, стоящий в очереди работ, задачей не судится ([ca846c1](https://github.com/Eyhenij/rt-tools/commit/ca846c1ac6b0a869818cc98aee8f54237801a93f))
- **rt:agent-kit:** действующее на дерево, а не на правку, лежит вне индекса ([31b3f73](https://github.com/Eyhenij/rt-tools/commit/31b3f7334911b12c457afcd0bf18acf0085ed29d))
- **rt:agent-kit:** заявка и её старение названы правилом, а отставание считает сверка ([aa05863](https://github.com/Eyhenij/rt-tools/commit/aa05863f67e17fa327ac8bf9d4b9a8f942391dde))
- **rt:agent-kit:** конфликтующая своя заявка чинится раньше новой работы ([4a237a1](https://github.com/Eyhenij/rt-tools/commit/4a237a110c3a92d03174963e44165c83d4545cd6))
- **rt:agent-kit:** неполный текст правила и опустошённое дерево названы прямо ([b1d3367](https://github.com/Eyhenij/rt-tools/commit/b1d3367f3d72e37a6fd5792c843b9325914be710))
- **rt:agent-kit:** обвязка пакета перестала обещать больше, чем делает ([757f8a2](https://github.com/Eyhenij/rt-tools/commit/757f8a2b155e47e9d5938690f66a4b2a0a434ba9))
- **rt:agent-kit:** признак проверки отвечает на заданный вопрос ([8352b4f](https://github.com/Eyhenij/rt-tools/commit/8352b4f8a7185fe65ccd214fbc00f7db72614635))
- **rt:agent-kit:** разбор решений спека получил два признака отбора и форму заголовка ([eacd491](https://github.com/Eyhenij/rt-tools/commit/eacd49198b341e12f67a01eb4c7c4bc2c3e8fb08))
- **rt:agent-kit:** разобранная папка читается как закрытие работы, а шаги правила не ждут слова ([12ce922](https://github.com/Eyhenij/rt-tools/commit/12ce922c6ddfb918fc58e13bb7c6194988911e02))
- **rt:agent-kit:** сверка называет надстройку профиля, о которой молчит компаньон ([5978581](https://github.com/Eyhenij/rt-tools/commit/59785816729be6acc6e614afc94eafbab527bc58))
- **rt:agent-kit:** сверка очереди работ судит связь задачи с эпиком в обе стороны ([276aff7](https://github.com/Eyhenij/rt-tools/commit/276aff7267d0002caa5e6214cdf8b92a79289ac2))
- **rt:agent-kit:** свои заявки перечитываются в трёх местах, а ход работы делается шагами целиком ([1f755ce](https://github.com/Eyhenij/rt-tools/commit/1f755ce5cb23c0b08f577e08430943be61b4461a))
- **rt:agent-kit:** слово владельца об устройстве — постановка, а не решение ([9c4518f](https://github.com/Eyhenij/rt-tools/commit/9c4518f0ff558fe2275e442f6b4a05f62323d8af))
- **rt:agent-kit:** стражи хода судят отданную работу и оба действия отказа ([e2d92bf](https://github.com/Eyhenij/rt-tools/commit/e2d92bf28c9b3460c8d70b316a94bf00f71286c9))
- **rt:agent-kit:** ход, правивший код без просьбы владельца, не кончается ([32720b6](https://github.com/Eyhenij/rt-tools/commit/32720b6e7611f56291bbd1b3ca46363fab9fd057))
- **rt:agent-kit:** чтением считается правило области работы, а влитая договорённость не запирает ветку ([73f75e4](https://github.com/Eyhenij/rt-tools/commit/73f75e4d42eb82e1c30191d99767c38c797a80b6))
- **rt:message-bus:** гард не выпускает ход, взявший запись груза без отметки ([dfdaa05](https://github.com/Eyhenij/rt-tools/commit/dfdaa0530af326dbce63d589dddfa733042fa7c7))
- **rt:message-bus:** издатель редакции закрывает записи соседнего дерева ([d5ee389](https://github.com/Eyhenij/rt-tools/commit/d5ee389494fa0c4ade626dc2be3a02cfc249a62c))

# [0.17.0](https://github.com/Eyhenij/rt-tools/compare/rt-agent-kit@0.16.1...rt-agent-kit@0.17.0) (2026-08-27)

### Bug Fixes

- **rt:agent-kit:** адрес репозитория спрашивается не у одного имени ([7de592e](https://github.com/Eyhenij/rt-tools/commit/7de592e3d904590da9d09193171982495acd03c9))
- **rt:agent-kit:** гард разбора считает чтением замысел эпика и описание прошлого ([c77bcee](https://github.com/Eyhenij/rt-tools/commit/c77bcee94d4d6dfb9681df121623ad1dcac03ed7))
- **rt:agent-kit:** гард хода работы не судит команду заведения задачи ([f5af1c2](https://github.com/Eyhenij/rt-tools/commit/f5af1c2d4683d157b6f9a5a0a5a07fb80d8ec83c))
- **rt:agent-kit:** долг привязок считается по разложенному телу правила ([7d1dca8](https://github.com/Eyhenij/rt-tools/commit/7d1dca86528240aebfc840e0b6e0cb34e621f683))
- **rt:agent-kit:** наборы груза берут свободный порт и отдают свой счёт ([8302738](https://github.com/Eyhenij/rt-tools/commit/83027388893748e885fe3f86c15dbdc8195e74d7))
- **rt:agent-kit:** настройка клиента хранилища ведёт к правилу поставки ([861f98f](https://github.com/Eyhenij/rt-tools/commit/861f98f4272a6a20d2ac4bb4d9f8bab08b305b1b))
- **rt:agent-kit:** отказ гейта правил зовёт спутник правила безусловно ([61a89d7](https://github.com/Eyhenij/rt-tools/commit/61a89d77b97c3dfaf918b44b8b9a7bb93bbf0ec5))
- **rt:agent-kit:** паттерн заведения правила показывает строку требования ([b6b58a9](https://github.com/Eyhenij/rt-tools/commit/b6b58a99ed145b7f154611b20efbc7a2b8bbad22))
- **rt:agent-kit:** перенаправление вывода не считается работой у стража выходов ([7e35d03](https://github.com/Eyhenij/rt-tools/commit/7e35d035d11208ed63c94668ee23d0a2eac681bf))
- **rt:agent-kit:** проверка длины не падает на снятом из рабочего дерева файле ([05f2498](https://github.com/Eyhenij/rt-tools/commit/05f24985b66946a1624cc81415e66c51b451b414))
- **rt:agent-kit:** проверка объявляет пропуск кодом возврата, а не строкой ([8d798c0](https://github.com/Eyhenij/rt-tools/commit/8d798c0c1c10545eec590b50cd0ecc1cdab41f67))
- **rt:agent-kit:** разложенный слой правил судится гардом замысла наравне с кодом ([bb8f343](https://github.com/Eyhenij/rt-tools/commit/bb8f343ed6751121e47e6684711cfaac4d6cd2e1))
- **rt:agent-kit:** снятие неотслеживаемого пути правкой продукта не считается ([6a48ad5](https://github.com/Eyhenij/rt-tools/commit/6a48ad51297f62b20759a493b96b814b98384a13))
- **rt:agent-kit:** собранное дерево правила о коде не требует ([c223d82](https://github.com/Eyhenij/rt-tools/commit/c223d8236aab5b7db8bdcb236e343d5c9386c63c))
- **rt:agent-kit:** стенд поднимается всегда, а форматтер трогает только своё ([b8d18e4](https://github.com/Eyhenij/rt-tools/commit/b8d18e4422e20db5e215cf27eab7db8af8e4a172))
- **rt:agent-kit:** стрелка в тексте команды перестала считаться записью ([9086722](https://github.com/Eyhenij/rt-tools/commit/9086722887fbb5417e04a791087b86a349aa7217))
- **rt:agent-kit:** у состояния влито одна строка следующего движения ([f1b485f](https://github.com/Eyhenij/rt-tools/commit/f1b485f1428dbae31be7143b5249d2ccf8284ed4))
- **rt:agent-kit:** черновик не снимается, пока ветка везёт папку своей задачи ([065d24b](https://github.com/Eyhenij/rt-tools/commit/065d24b941b0bffa877a2f78a4ca1fe0a01ed5c2))

### Features

- **rt:agent-kit:** блокированная задача следующей не считается ([4cd7f5e](https://github.com/Eyhenij/rt-tools/commit/4cd7f5e8aa9e8a8f9852189d63b8e8c249842b81))
- **rt:agent-kit:** видимость заведённого проверяется той стороной, которой оно предназначено ([2a03e95](https://github.com/Eyhenij/rt-tools/commit/2a03e957aca15786141e068d741f7646f54b6b1e))
- **rt:agent-kit:** договорённость о продукте называется и спеком домена ([278e8ec](https://github.com/Eyhenij/rt-tools/commit/278e8ecde921f4d12086a5704b2582a5b63c5f08))
- **rt:agent-kit:** договорённость о продукте требует свой гард ([b4fbd51](https://github.com/Eyhenij/rt-tools/commit/b4fbd512ab60607697eeb602ed115a83ab1b4d3c))
- **rt:agent-kit:** журнал выпусков делится тем движением, которое его растит ([634ee50](https://github.com/Eyhenij/rt-tools/commit/634ee5016f206814e56f344958584e72ada34471))
- **rt:agent-kit:** линтер идёт и по следам записи оболочкой ([fed6df3](https://github.com/Eyhenij/rt-tools/commit/fed6df35fc063840c4c8e9de296f54e4fbedd58c))
- **rt:agent-kit:** набор гейта зовёт умолчание пакета, а не перечисляет его строками ([9e6c5c4](https://github.com/Eyhenij/rt-tools/commit/9e6c5c471b7f8ad26b1924b458da2df3e557a9c6))
- **rt:agent-kit:** названное владельцем состояние снимается вызовом ([2f897d1](https://github.com/Eyhenij/rt-tools/commit/2f897d19e37dd9e8a9bd10b4e81d24ab3a5e02f6))
- **rt:agent-kit:** ожидание своего замера ведётся одним ожиданием ([18c5a32](https://github.com/Eyhenij/rt-tools/commit/18c5a32fdd1ebc80ff791f65725d4ce8f0644b48))
- **rt:agent-kit:** ожидание части работы остановкой всей работы не бывает ([847b2d5](https://github.com/Eyhenij/rt-tools/commit/847b2d5a2d3bdf21797c271e3c3f1ce132612445))
- **rt:agent-kit:** осмотр называет разделы, замещённые надстройками ([2196e9a](https://github.com/Eyhenij/rt-tools/commit/2196e9a9a56d409f053f1798875c9cc7c5081d18))
- **rt:agent-kit:** отбор находит записи, у которых отметка отстала от слияния ([411662b](https://github.com/Eyhenij/rt-tools/commit/411662b95540476857e90c96a5a80e158bd5c5fb))
- **rt:agent-kit:** отказ гейта называет, что потребуется дальше по команде ([e9b4696](https://github.com/Eyhenij/rt-tools/commit/e9b4696f8b470585f80964f8a88b80dbc276e5d5))
- **rt:agent-kit:** отказ стража окна называет формы вызова, которые проходят ([8f3bf45](https://github.com/Eyhenij/rt-tools/commit/8f3bf45d79a0b45aaee0162363ce20cbff9f8a86))
- **rt:agent-kit:** открытая заявка перечитывается той записью, которая будет её вливать ([6df3d45](https://github.com/Eyhenij/rt-tools/commit/6df3d45c4cff1ad113a9ccc7b9e21bd8808e8d34))
- **rt:agent-kit:** половина гарда разговора объявлена своим ресурсом ([152ae57](https://github.com/Eyhenij/rt-tools/commit/152ae572b4cdce88115a0a0bbaa8099495107781))
- **rt:agent-kit:** помощник профиля говорит, что не сумел назвать профиль ([3faa496](https://github.com/Eyhenij/rt-tools/commit/3faa4966fbbe13d92d987f70168dd5e193cb6472))
- **rt:agent-kit:** признак дерева, раскладка как правка и подъём версии одним изменением ([369551d](https://github.com/Eyhenij/rt-tools/commit/369551d5507b690fc18ff639fe3f660a867ecccd))
- **rt:agent-kit:** причина исключения гейта пуша судится на живость названной задачи ([a223a44](https://github.com/Eyhenij/rt-tools/commit/a223a446f36cef27e9c540b304a8c25e5aa32bdf))
- **rt:agent-kit:** прогон не требуется там, где конвейер ветку не слушает ([ecb028d](https://github.com/Eyhenij/rt-tools/commit/ecb028dc1eb8ced425f6856ec6d947680d5118a1))
- **rt:agent-kit:** путь выкатки проверяется до того, как на него обопрутся ([4ba5120](https://github.com/Eyhenij/rt-tools/commit/4ba51208dc15d15f9dbd533b1ce97159edc4a979))
- **rt:agent-kit:** работы, идущие подряд, ветвятся чередой ([72f0c7e](https://github.com/Eyhenij/rt-tools/commit/72f0c7e42572a2bc99f77ac77aa2b68994566e1b))
- **rt:agent-kit:** разбор с владельцем называет, где ищется ответ и из чего не выводится вопрос ([c30c919](https://github.com/Eyhenij/rt-tools/commit/c30c9190cbf7e5ea2e6cc2efd5baece00e780753))
- **rt:agent-kit:** разбор состояния называет разделы, замещённые надстройками ([4e371cf](https://github.com/Eyhenij/rt-tools/commit/4e371cf284b3f72d62dbeae64f6a5c2d6cf220b9))
- **rt:agent-kit:** раздел об оставшемся шаге стоит в теле заявки с минуты открытия ([478dcb1](https://github.com/Eyhenij/rt-tools/commit/478dcb1b6897db74e1abbc8b1c03e0f0aace24ab))
- **rt:agent-kit:** раскладка кладёт объявление хука вместе с самим хуком ([4c85c94](https://github.com/Eyhenij/rt-tools/commit/4c85c9426984ae0a1e0ee21f84b22c34bdff5436))
- **rt:agent-kit:** раскладка называет надстройку, не подобранную ни к чему ([f7e7196](https://github.com/Eyhenij/rt-tools/commit/f7e71967947dace3420a03d0d539a2084d14e30d))
- **rt:agent-kit:** решение, переживающее задачу, записывается там, где переживёт ([4f6774b](https://github.com/Eyhenij/rt-tools/commit/4f6774b571ee76dda84d75d885bdae47a27c3de6))
- **rt:agent-kit:** сверка называет открытые задачи с совпадающими заголовками ([40a3b7d](https://github.com/Eyhenij/rt-tools/commit/40a3b7d4921dc866e171a2648f4d5c6ffff108dc))
- **rt:agent-kit:** свободный номер сценария ищется во всех ветках ([477edf8](https://github.com/Eyhenij/rt-tools/commit/477edf85913ca0b3c55c10dbea8d6f48c5078b11))
- **rt:agent-kit:** сводка называет местные значения, которых ждут хуки ([e288492](https://github.com/Eyhenij/rt-tools/commit/e28849248bb8955ef3189f60995d0b0530790ce6))
- **rt:agent-kit:** словарь зовёт службу приёмником, а запретное слово краснеет проверкой ([85a0601](https://github.com/Eyhenij/rt-tools/commit/85a06017c588458b95a0622f3aae36fe57ed7f3b))
- **rt:agent-kit:** состояние вперёд и остаток вопросом — то же объявление намерения ([14383e0](https://github.com/Eyhenij/rt-tools/commit/14383e06065695be12779c6c320eb03c9eb5b8eb))
- **rt:agent-kit:** указатель заводится каталогу, который читают по нему ([a184f9c](https://github.com/Eyhenij/rt-tools/commit/a184f9ce0f658dda3858879c3341dfda867f5ea3))
- **rt:agent-kit:** хук называет папки задач, не найдя своей ([45f0359](https://github.com/Eyhenij/rt-tools/commit/45f03594ae97bea7203b51672b735adb1c6d03b0))
- **rt:message-bus:** отбор записей груза, чья статья уже стоит в дереве ([c08d5b8](https://github.com/Eyhenij/rt-tools/commit/c08d5b830cc1dbdbaed0d289755bb95f4f50672d))
