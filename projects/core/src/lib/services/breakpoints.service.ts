...
export class BreakpointService {
    ...
    public readonly isDesktop: Signal<TNullable<boolean>> = toSignal<TNullable<boolean>>(
    ...
    public readonly isSmallDesktop: Signal<TNullable<boolean>> = toSignal<TNullable<boolean>>(
    ...
    public readonly isMobile: Signal<TNullable<boolean>> = toSignal<TNullable<boolean>>(
    ...
    public readonly isTablet: Signal<TNullable<boolean>> = toSignal<TNullable<boolean>>(
    ...
    public readonly isSmallTablet: Signal<TNullable<boolean>> = toSignal<TNullable<boolean>>(
