## [0.3.2](https://github.com/Eyhenij/rt-tools/compare/rt-store@0.3.1...rt-store@0.3.2) (2026-09-03)
...
- **rt:store:** стор не отдаёт пустоту там, где обещает значение ([48e35b5](https://github.com/Eyhenij/rt-tools/commit/48e35b5cc7d6ea1ab2457712c23cee2d8a2bb350))
...
# [0.2.0](https://github.com/Eyhenij/rt-tools/compare/rt-store@0.1.0...rt-store@0.2.0) (2026-08-02)

# [0.1.0](https://github.com/Eyhenij/rt-tools/compare/rt-store@0.0.8...rt-store@0.1.0) (2026-08-02)
...
- `BaseStoreService` - Signal-based synchronous state management
- `BaseAsyncStoreService` - Extended store with async operation handling
- Redux DevTools integration with time-travel debugging
- `ModelStatus` enum for request status tracking
- `IStateBase.Async` and `IStateBase.List` interfaces
- `BASE_INITIAL_STATE.ASYNC` constant for initial state
