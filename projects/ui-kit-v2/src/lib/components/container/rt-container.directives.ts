// Маркеры слотов переехали в соседний файл — иначе оболочка и панельные директивы замыкали
// круг импортов. Здесь они остаются видимыми прежним потребителям.
export * from './rt-container.markers';
