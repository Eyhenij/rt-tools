...
@Component({
    ...
    template: `
        @switch (part) {
            ...
            @case ('actions') {
                <app-story-presets caption="Кнопки по отдельности в обоих наборах">
                    <ng-template>
                        <app-story-row slotWidth="17rem" [items]="actionCases">
            ...
            @case ('name') {
                <app-story-presets caption="Имя файла решает иконку и заголовок в обоих наборах">
                    <ng-template>
                        <app-story-row slotWidth="17rem" [items]="names" [itemLabel]="nameLabel">
            ...
            @case ('weight') {
                <app-story-presets caption="Вес файла в обоих наборах">
                    <ng-template>
                        <app-story-row slotWidth="17rem" [items]="weights" [itemLabel]="weightLabel">
