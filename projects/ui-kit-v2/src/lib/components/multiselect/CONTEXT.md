...
- Ширина панели не меньше ширины триггера и дальше растёт по содержимому; прокрутки внутри нет.
  Задаётся входами `panelWidth` и `panelMaxHeight` — так же, как у `rt-select`.
