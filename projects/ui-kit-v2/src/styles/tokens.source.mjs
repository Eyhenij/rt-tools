/* Источник свойств оформления второго кита.
   ...
   `note` — записку в его строке, обе уезжают в собранный файл как есть. Поле `presetShared`
   несёт причину, по которой цвет назначения один в обоих наборах; в собранный файл оно не
   уезжает и читается одной проверкой — `tools/check-preset-complete.mjs`.
   ...
   назначений — `tokens.light-color.mjs`, цвет названных частей кита — `tokens.light-parts.mjs`,
   набор и контролы формы — `tokens.light-forms.mjs`,
