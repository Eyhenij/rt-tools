 ...
 *
 * Тёмная половина получает класс `.app-story-themes__pane--dark`, а сам набор свойств для
 * него объявлен в `.storybook/storybook.scss`: свойства тёмной темы кит вешает на `:root`,
 * и скоупнуть их можно только там, где стиль глобальный.
 *
