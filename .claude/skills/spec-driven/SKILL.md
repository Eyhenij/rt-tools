...
---
<!-- rt-kit v0.2.0 · rules/spec-driven.md · 08874bae891f · правится надстройкой, не здесь -->

# Документация проекта — каким приёмом

Правило под закон `docs/constitution/project-documentation.md`. Закон говорит, что должно быть верно
...
```
ЗАКОН      docs/constitution/<закон>.md
  ...
  │             .claude/skills/<правило>/implementation.md — имена этого дерева и привязка к коду
  │
