...
---
<!-- rt-kit v0.17.0 · rules/spec-driven.md · e5fba054430f · правится надстройкой, не здесь -->
...
- **Первая колонка компаньона — текст статьи, скопированный, а не пересказанный.** Ключ связи —
  ...
  заполненной. Проверка считает статьи без адреса и о статье, адрес которой описывает не её, не
  знает ничего: совпадает род, а не перечень, и строка стоит до перечитывания диффа.
