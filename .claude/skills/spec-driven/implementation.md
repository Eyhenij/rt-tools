...
| Префикс сценариев в домене один.                                              | `SC-AK` у `docs/specs/agent-kit/`, `SC-UKV` у `docs/specs/ui-kit-v2/`; единственность префикса в каталоге сверяет `pnpm run check:specs`.                   |
