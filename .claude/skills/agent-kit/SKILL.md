...
---
<!-- rt-kit v0.16.1 · skills/agent-kit.md · f43fa582402f · правится надстройкой, не здесь -->
...
Сравнивать при этом не с чем, если прежняя редакция не снята копией: установка стирает её без
следа. Снимок — первая команда подъёма, до установки:

```bash
cp -r node_modules/@rt-tools/agent-kit/assets /tmp/agent-kit-assets-<прежняя версия>
```

По каждому названному разделу сверяются статьи. Совпадения заголовков мало — заголовок как раз
и совпал, этим раздел замещён:
