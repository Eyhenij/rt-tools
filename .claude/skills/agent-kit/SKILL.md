...
---
<!-- rt-kit v0.16.1 · skills/agent-kit.md · c682a3b968fd · правится надстройкой, не здесь -->
...
приглашения — код заводит дерево в приёме и кладёт токен в файл, названный ключом `token`.
Потребитель ни того ни другого не придумывает: до приглашения отправка отказывает по
устройству, а не по недонастройке.
