...
---
<!-- rt-kit v0.8.2 · skills/agent-kit.md · 898d41b60c62 · правится надстройкой, не здесь -->
...
закрытую задачу, `/agent-kit-digest` сводит накопленное в правки ресурсов, а `/rules-review`
читает семью текстов — закон, его правила и паттерны при них — и ищет то, чего не считает ни
одна проверка: два текста, говорящих об одном разное, и случай, которого не назвал ни один.
