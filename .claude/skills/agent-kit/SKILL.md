...
---
<!-- rt-kit v0.16.1 · skills/agent-kit.md · 218acede3133 · правится надстройкой, не здесь -->
...
Совпадения заголовков при сверке мало — заголовок как раз и совпал, этим раздел замещён;
сверяются статьи:
