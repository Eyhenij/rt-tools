<!-- rt-kit v0.16.1 · pitfalls/agent-kit.md · 678728d30ba9 · правится надстройкой, не здесь -->
...
- **Пополненный раздел, замещённый надстройкой, пропадает молча — и счёт этому идёт десятками.**
  ...
  Прежняя редакция при этом нашлась случайной копией в чужом рабочем дереве: установка стирает
  её без следа, поэтому снимок и стоит первым шагом подъёма.
