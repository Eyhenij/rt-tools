...
- **The removal by expiry is not carried by whichever branch pushed first.** — **Not checked by anything.** The cleanup command is called by hand and by the push gate. Neither knows what the branch it stands in is about. Held by this article: the cleanup is opened as work of its own.
