<!-- rt-kit v0.25.0 · pitfalls/doc-style.md · 517d05e22fd3 · правится надстройкой, не здесь -->
...
- **Проход по словарю глазами слово не находит.** «Формулировки приведены к словарю» означает
  ...
  соседней строке того же файла. Слово из левой колонки таблицы «Not written here» вычищается
