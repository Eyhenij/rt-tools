...
---
<!-- rt-kit v0.8.2 · rules/testing.md · 8bb37ab9066f · правится надстройкой, не здесь -->
...
flowchart TD
    ...
    I -->|Да| J[Покрытием не считается: выключенный тест зелен всегда]
    I -->|Нет| K[В заголовке теста стоит номер сценария]
    H --> K
    K --> L{Сценарий остался без теста}
