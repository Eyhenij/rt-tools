...
---
<!-- rt-kit v0.17.0 · patterns/task-flow-start.md · 668f56a3a5c3 · правится надстройкой, не здесь -->
...
допущением: <что принято>», и работа идёт дальше. Неверное допущение стоит правки; вопрос ради
очевидного — захода.
