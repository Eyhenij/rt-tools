...
---
<!-- rt-kit v0.20.0 · patterns/task-flow-start.md · 81aa505be177 · правится надстройкой, не здесь -->
...
Тело приходит файлом и пустым не бывает: заведённая пустой задача не говорит ничего ни
исполнителю, ни владельцу, а дописать её потом можно только со слова владельца — и заводится
пустое молча, номером наравне с полным.
...
Номер уже выдан — черновика нет и не заводится: папка открывается сразу под именем ветки, а
разбор пишется в неё же. Так начинается половина работ: номер приходит прошлым заходом,
замеченным дефектом или соседней задачей, и шаг с черновиком тогда неисполним — переименовывать
нечего. Ловушка «номер не бывает первым» сюда не относится: она про то, что задачу не заводят до
разбора, а не про то, что с уже заведённой нельзя работать.
