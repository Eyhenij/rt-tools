...
---
<!-- rt-kit v0.20.0 · patterns/task-flow-start.md · 6ea49bdd40dd · правится надстройкой, не здесь -->
...
замысла, у которого нет этапов, а следующий заход доверяет папке задачи. Образец открывается тем же движением, которым заполняется; шапку раскладки с копии снимают
тут же — иначе правку отобьёт гард, и ловушка при правиле объясняет почему:
