...
---
<!-- rt-kit v0.8.1 · patterns/task-flow-resume.md · c32f8f9c7b60 · правится надстройкой, не здесь -->
...
Задача закрыта, отчёт открыт и ждёт владельца — заход на этом не кончается. Отданное на разбор
