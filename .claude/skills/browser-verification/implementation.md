...
- **Прокси стенда подставляет то, по чему приложение узнаёт арендатора запроса.** — **Не применимо.** Арендаторов у библиотеки нет: единственный стенд — витрина, и запрос в ней ничей.
