...
---
<!-- rt-kit v0.16.1 · rules/browser-verification.md · c9296b8c694c · правится надстройкой, не здесь -->
...
- **Снятие процесса бывает отбито, и тогда стенд поднимается рядом, а не вместо.** Отбить его
  может среда исполнения — в том числе по своему же стенду прошлого захода, — и ни разрешение
  на команду, ни переформулировка тут не помогают: ход тратится на попытки. Ход отсюда один:
  свободный порт для нового стенда, а список оставленного называется владельцу в конце захода —
  снять их может только он. Не названные, стенды копятся заходами и держат соединения к
  хранилищу.
