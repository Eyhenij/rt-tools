...
---
<!-- rt-kit v0.23.0 · patterns/browser-verification-stand.md · 30f2af466752 · правится надстройкой, не здесь -->
...
Раздел этого дерева: сайта и сервера отрисовки здесь нет вовсе, а стендов два — витрина набора
...
Выводов про кэш, перенаправления и заголовки на этих стендах не делают вовсе: делать их не на чем.
