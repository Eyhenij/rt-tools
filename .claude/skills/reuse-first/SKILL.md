...
---
<!-- rt-kit v0.23.0 · rules/reuse-first.md · f2b86cb05678 · правится надстройкой, не здесь -->
...
- **Ограничение, придуманное на месте, проверяется поиском по дереву прежде, чем стать доводом.**
  ...
  дерево ходит каждый день, и тянет за собой перебор вариантов, ни одному из которых не было
  нужды появляться: решение «править класс чужого набора из приложения нельзя» стоило четырёх
  кругов и ложного слова владельцу, пока образец ровно такой правки лежал в том же файле — с
  доводом в соседней строке.
