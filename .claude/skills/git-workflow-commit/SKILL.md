...
---
<!-- rt-kit v0.8.1 · patterns/git-workflow-commit.github.md · cccfb8a7cf77 · правится надстройкой, не здесь -->
...
ненулевым кодом. В комментарий, в тело отчёта и в замысел идёт этот ответ, а не напечатанный
...
1. **Главная ветка влита в эту ветку** — `git fetch origin && git merge origin/main`.
   ...
   главная уходит вперёд — чаще всего собственным отчётом того же исполнителя, влитым час
   назад.
