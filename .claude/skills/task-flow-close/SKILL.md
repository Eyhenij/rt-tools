...
---
<!-- rt-kit v0.17.0 · patterns/task-flow-close.md · 665740613fba · правится надстройкой, не здесь -->
...
- **Тело заявки остаётся старше разбора папки.** Разбор — последний коммит ветки, и он же делает
  неправдой всё, что тело обещало сделать до слияния: папку, вливание договорённости, приведение
  текстов. Ревьювер читает список оставшегося как оставшееся. Тело правится тем же ходом, что и
  разбор, — паттерн заявки.
