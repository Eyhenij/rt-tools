...
---
<!-- rt-kit v0.8.1 · patterns/task-flow-close.md · d36247999919 · правится надстройкой, не здесь -->
...
**Заход, открывший отчёт, называет владельцу оставшийся шаг вслух:** после одобрения ветка
...
кончена» — видит зелёный отчёт и мержит его тем же ходом. Промах случается ровно в шов между
