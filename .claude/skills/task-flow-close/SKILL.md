...
---
<!-- rt-kit v0.14.0 · patterns/task-flow-close.md · 2d12e263c9c3 · правится надстройкой, не здесь -->
...
формулировки и заголовок, заголовок последним: он выглядит частью формы, а не частью текста. В
дереве, где заявки пишутся на другом языке, это уже дважды уехало на хостинг, и оба раза до
чужого заголовка посреди чужого языка добрались глазами. То же верно и для двух сообщений
