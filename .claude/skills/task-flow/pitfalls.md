<!-- rt-kit v0.20.0 · pitfalls/task-flow.md · d415457ec88e · правится надстройкой, не здесь -->
...
- **Признак готовности этапа пишется о своей половине вывода, а не обо всём выводе.** Проверка
  дерева считает всё дерево, а этап правит его часть: обещание «вывод без единой строки долга»
  не сходится не потому, что этап не сделан, а потому, что три строки принадлежат невлитой
  соседней ветке. Признак называет то, что этот этап меняет, — свои строки, своё число, своё
  место в выводе; сказанное обо всём выводе разбирается чужой работой и держится ровно до
  первого соседа.
