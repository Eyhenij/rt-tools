...
---
<!-- rt-kit v0.17.0 · rules/task-flow.md · 81383cc3502c · правится надстройкой, не здесь -->
...
- **Что требует слова владельца, берётся списком, а не оценкой на месте.** Оценку «это
  безопасно» назначает тот, кому она удобна, и меняется она с настроением разговора, а не со
  свойствами команды: за один заход одна и та же команда была сначала слишком опасной, чтобы её
  позвать, а через два хода — достаточно безопасной, чтобы позвать без спроса. Недовольство
  владельца простоем разрешением не бывает.
...
- **Ожидание одной части этапа остановкой этапа не бывает.** Части, которые от ожидаемого не
  ...
  шаг, — этим ожидание и отличается от остановки.
