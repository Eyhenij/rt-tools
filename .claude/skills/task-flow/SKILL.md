...
---
<!-- rt-kit v0.16.1 · rules/task-flow.md · de5e2318a28e · правится надстройкой, не здесь -->
...
- **Замысел эпика лежит там, где его найдут без сети и после мержа.** Карточка говорит, что эпик
  ...
  Каталог называет компаньон правила. Состав и порядок — не всё, что там живёт: имя, адрес и
  способ, названные владельцем по ходу, дописываются туда же тем ходом, каким приняты.
...
- **Ветка, снёсшая папку, обязана прибавить запись в архив.** Снести дешевле, чем разобрать, и
  первым уходит разбор просьбы — единственная запись слов владельца. Что увезено, судит владелец.
