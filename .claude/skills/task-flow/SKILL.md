...
---
<!-- rt-kit v0.17.0 · rules/task-flow.md · e07c7f63bd10 · правится надстройкой, не здесь -->
...
- **Заход работу не начинает сам.** Начало требует слова владельца в этом же заходе: передача,
  ...
  том, работать ли. Заход без просьбы начинается с вопроса, продолжать ли.
- **Указание работать по ходу работы покрывает все его шаги, включая меняющие историю.** Отметка
  сделанного этапа, пуш и открытие заявки предписаны им самим, и отдельного слова на каждый не
  требуется: спрашивают о том, чего в нём нет.
- **Вопрос, записанный прошлым заходом, вопросом владельца не становится.** Открытый вопрос
  передачи адресован её автору: часть таких вопросов закрыта шагом работы, и передавать их —
  значит спрашивать про уже назначенное.
...
- **Ожидание одной части этапа остановкой этапа не бывает.** Части, которые от ожидаемого не
  зависят, делаются тем же ходом. Владельцу называется, что уже сделано и что осталось на его
  шаг, — этим ожидание и отличается от остановки. Отбитая гардом команда и отклонённый владельцем
  вызов читаются тем же порядком: они выглядят стеной, а не вопросом, и останавливают ход целиком
  там, где остановили один его пункт. Сперва делается всё, что мимо них.
...
- **Следующая задача берётся из замысла эпика, а очередь работ спрашивается там, где эпика нет.** По
  списку, отсортированному номером, первая задача чужого эпика неотличима от своей. Кончившийся эпик
