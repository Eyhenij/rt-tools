...
---
<!-- rt-kit v0.16.1 · rules/task-flow.md · 8fb3927257fc · правится надстройкой, не здесь -->
...
- **Открытие PR и снятие черновика отбиваются, пока ветка везёт папку своей задачи.** Требование
  стоит здесь, а не на слиянии: слияние нажимает человек на хостинге, где гардов нет, и его отказ
  до владельца не доходит. Снятый черновик он читает как приглашение влить и нажимает кнопку, не
  дожидаясь коммита уборки, — три работы подряд уехали в главную именно так. Судится содержимое
  ветки, а не рабочее дерево.
