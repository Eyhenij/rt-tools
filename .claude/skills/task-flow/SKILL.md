...
---
<!-- rt-kit v0.8.1 · rules/task-flow.md · 51eb74b5cb7a · правится надстройкой, не здесь -->
...
- **Просьба о слиянии — отдельный ход, и раньше уборки её не бывает.** Порядок один: PR открыт
  → прогон зелёный → папка задачи разобрана и запушена → исполнитель просит влить, называя
  номер. До этой просьбы работа не готова, сколько бы зелёного на её странице ни было.
