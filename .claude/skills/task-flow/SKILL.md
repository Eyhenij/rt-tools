...
---
<!-- rt-kit v0.4.0 · rules/task-flow.md · 9c0bc10948c6 · правится надстройкой, не здесь -->
...
Разбор папки при закрытии не проверяется по существу: гард поставки видит, что папка уезжает в
главную ветку, и что в архив от ветки что-то прибыло, но не судит, то ли это прибыло и стоило
ли увозить именно это. Сверять содержимое машине нечем — судит владелец на разборе отчёта.
Отсюда и обход: работа, вливаемая частями, папку до конца не разбирает, а причина остаётся в
отчёте.
