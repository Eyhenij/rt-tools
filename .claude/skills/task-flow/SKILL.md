...
---
<!-- rt-kit v0.17.0 · rules/task-flow.md · f286a1ee5acb · правится надстройкой, не здесь -->
...
- **Ожидание одной части этапа остановкой этапа не бывает.** Части, которые от ожидаемого не
  ...
  вызов читаются тем же порядком: они выглядят стеной, а не вопросом, и потому останавливают ход
  целиком там, где остановили один его пункт. Сперва делается всё, что мимо них, — вливание
  договорённости, приведение текстов, разбор папки, — и только потом идёт слово владельцу.
