...
---
<!-- rt-kit v0.16.1 · rules/task-flow.md · fa01baeca4fc · правится надстройкой, не здесь -->
...
- **Папка задачи едет в ветку коммитом, а не живёт в одном рабочем дереве.** Гард спрашивает её
  с диска, и незакоммиченная папка проходит все правки без отказа, а признак отданной работы
  берётся из истории — отказ приходит в последней точке, на открытии заявки, когда замысел уже
  снят своими руками. Вне истории законен один черновик без номера: заводить в неё нечего, пока
  нет имени.
