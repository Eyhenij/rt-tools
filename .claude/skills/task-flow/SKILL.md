...
---
<!-- rt-kit v0.17.0 · rules/task-flow.md · 2ce025208376 · правится надстройкой, не здесь -->
...
- **Что требует слова владельца, берётся списком, а не оценкой на месте.** Оценку «это
  безопасно» назначает тот, кому она в эту минуту удобна, и меняется она с настроением разговора,
  а не со свойствами команды: за один заход одна и та же команда была сначала слишком опасной, а
  через два хода — достаточно безопасной, чтобы позвать без спроса. Недовольство владельца
  простоем разрешением не бывает.
