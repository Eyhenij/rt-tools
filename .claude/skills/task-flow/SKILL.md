...
---
<!-- rt-kit v0.22.0 · rules/task-flow.md · f1124888a9c4 · правится надстройкой, не здесь -->
...
- **На команду владельца ответ начинается с результата, а не с намерения и не с его обоснования.**
  ...
  решении читается как его оценка: авторство решения переписывается на исполнителя, и владельцу
  приходится возвращать его себе отдельной репликой. Исключение одно — исполнение упёрлось в
  препятствие: тогда называется препятствие, а не отношение к задаче.
...
- **Слово владельца об устройстве — постановка, а не решение.** Названное им обычно уже живёт в
  дереве под этим самым словом — именем на экране, разделом спека, полем модели, — и слово
  сверяется с ними до правки. Разошлось прочтение — спрашивается владелец: истолкованное по
  ближайшему коду выглядит исполненной просьбой ровно до приёмки.
...
- **Что действует на дерево, а не на правку, лежит вне индекса.** Путь к образцу и разрешение
  ...
  Место записи — рядом с передачей захода.
