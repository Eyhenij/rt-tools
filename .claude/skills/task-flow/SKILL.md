...
---
<!-- rt-kit v0.11.0 · rules/task-flow.md · 49168a486d53 · правится надстройкой, не здесь -->
...
Переход из состояния в состояние ходом не кончается тем более: обязательное
действие сделано, и следующее делается тем же ходом. Граница состояния выглядит законченным
куском лучше всякой другой вехи — сделанное названо, отчитаться есть чем, — и отчёт встаёт
ровно туда, где должно было стоять следующее действие. Что делается сразу за обязательным
действием, называет сам раздел состояния строкой следующего движения.
