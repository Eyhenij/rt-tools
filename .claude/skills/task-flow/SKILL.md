...
---
<!-- rt-kit v0.4.0 · rules/task-flow.md · 5b1a8af96cfa · правится надстройкой, не здесь -->
...
- **Тексты, задетые работой, приводятся к сделанному до разбора папки.** Что перечитывать,
  названо в замысле; разбор папки его удаляет, и после него остаётся только память. Правило и
