...
---
<!-- rt-kit v0.17.0 · rules/task-flow.md · eecbe0b1d001 · правится надстройкой, не здесь -->
...
- **Что требует слова владельца, берётся списком, а не оценкой на месте.** Оценку «это безопасно»
  назначает тот, кому она в эту минуту удобна, и меняется она с настроением разговора, а не со
  свойствами команды. Недовольство владельца простоем разрешением не бывает.
...
- **Указание работать по ходу работы покрывает все его шаги, включая меняющие историю.** Отметка
  этапа, пуш и открытие заявки предписаны им самим: спрашивают о том, чего в нём нет.
- **Вопрос, записанный прошлым заходом, вопросом владельца не становится.** Он адресован автору
  передачи: часть таких вопросов закрыта шагом работы, и передавать их — значит спрашивать про
  назначенное.
...
- **Указание работать ходом работы — это указание делать его шаги, включая те, что меняют историю.**
  Отметка сделанного этапа, пуш и открытие заявки ходом работы предписаны, и отдельного слова на
  каждый из них не требуется: спросить надо о том, чего в ходе работы нет вовсе. Прочитанное иначе,
  указание владельца становится разрешением делать половину шагов, а работа встаёт на строке,
  которую заход написал себе сам.
...
- **Эпик не закрывается по признаку, подтверждённому только чтением.** Признак, проверяемый
  ...
  «подтверждается живым замером» — обещание, а не проверка.
