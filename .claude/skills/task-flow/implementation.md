...
| Просьба о слиянии — отдельный ход, и раньше зелёного прогона её не бывает.                                | `.claude/hooks/git-guard-draft-ready.sh:verdict` — ход не заканчивается, пока разобранная ветка стоит черновиком при зелёном прогоне на вершине PR                                                                                                            |
