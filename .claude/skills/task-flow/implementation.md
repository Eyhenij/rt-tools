...
| Отказ гарда кончает ход.                                                                                   | **Не проверяется ничем.** Гард знает свой отказ и не знает, что было после него; обход же ловится тем, что гарды судят и команду оболочки                                |
