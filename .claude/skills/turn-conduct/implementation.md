...
- **A refusal of a guard ends the turn only as its last action.** — `.claude/hooks/turn-exit-verdict.sh:last_out` — the last tool result of the turn is matched against the refusal samples.
