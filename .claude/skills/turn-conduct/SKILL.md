...
---
<!-- rt-kit v0.16.1 · rules/turn-conduct.md · e1d940a6e31c · правится надстройкой, не здесь -->
...
- **Названное владельцем состояние дерева снимается вызовом раньше объяснения.** «Конфликты»,
  ...
  трогая при этом ни одной ветки. Вопрос «почему», стоящий в том же сообщении, требования снять
  состояние не отменяет — он идёт вторым.
