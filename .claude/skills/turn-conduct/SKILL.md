...
---
<!-- rt-kit v0.17.0 · rules/turn-conduct.md · 85310d7dc6e1 · правится надстройкой, не здесь -->
...
- **Признак необратимости берётся из списка, а не выводится доводом.** Список составлен тем, кто
  ...
  всегда, а список — только когда его прочитали, и довод поверх списка отменяет его молча: со
  стороны это выглядит осторожностью, а не пропуском шага. Действия, которого в списке нет,
  исполнитель на слово владельца не гейтит, даже если оно уходит наружу.
