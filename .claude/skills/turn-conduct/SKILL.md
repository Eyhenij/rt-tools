...
---
<!-- rt-kit v0.16.1 · rules/turn-conduct.md · cbf19a3b12fd · правится надстройкой, не здесь -->
...
- **Признак необратимости берётся из списка, а не выводится доводом.** Список составлен тем, кто
  ...
  слово владельца не гейтит, даже если оно уходит наружу. Шаг, снятый из списка разбором прошлого
  промаха, тем более: довод, которым его туда возвращают, уже разобран и отклонён — и дважды
  подряд готовая работа вставала перед снятым шагом.
