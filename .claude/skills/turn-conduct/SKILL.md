...
---
<!-- rt-kit v0.17.0 · rules/turn-conduct.md · d04e31c87bd1 · правится надстройкой, не здесь -->
...
- **Ожидание своего же замера ведётся одним ожиданием, а не уведомлением на каждый шаг.**
  Уведомление ставится там, где на каждое событие надо действовать; где значим только итог —
  одно ожидание, кончающееся вместе с замером. Иначе замер назначает себе ход на каждый свой
  шаг, а наполнить их нечем.
...
- **Признак необратимости берётся из списка, а не выводится доводом.** Список составлен тем, кто
  ...
  списке нет, исполнитель на слово владельца не гейтит, даже если оно уходит наружу; шаг, снятый
  разбором прошлого промаха, — тем более.
- **Ход, в котором исполнитель признал промах, не заканчивается, пока записи о происшествии нет.**
  ...
  ловить раньше нечего. Каталог записей называет компаньон правила, имя файла — дата и чем был
  промах, форму держит образец раскладки. Находка разбора говорит о тексте правила, запись — о
  случившемся в работе. Признание ловится набором образцов, а не пониманием смысла; промах,
