...
---
<!-- rt-kit v0.16.1 · rules/turn-conduct.md · ca14d3e9f76a · правится надстройкой, не здесь -->
...
- **Признак необратимости берётся из списка, а не выводится доводом.** Список составлен тем, кто
  ...
  список молча: со стороны это выглядит осторожностью, а не пропуском шага. Действия, которого в
  списке нет, исполнитель на слово владельца не гейтит, даже если оно уходит наружу.
