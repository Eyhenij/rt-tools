...
---
<!-- rt-kit v0.17.0 · rules/turn-conduct.md · b7066b71b517 · правится надстройкой, не здесь -->
...
- **Ход, в котором исполнитель признал промах, не заканчивается, пока записи о происшествии нет.**
  ...
  промах, форму держит образец раскладки: находка разбора говорит о правиле, запись — о работе.
  Признание ловится набором образцов: промах, признанный словами вне набора, гард пропускает.
