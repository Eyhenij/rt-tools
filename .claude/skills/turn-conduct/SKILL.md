...
---
<!-- rt-kit v0.16.1 · rules/turn-conduct.md · a76d78ed2ff5 · правится надстройкой, не здесь -->
...
- **Свой незакрытый шаг владельцу не передаётся.** Чужой шаг сводкой называют, свой — делают:
  незапушенная ветка, неотмеченная запись груза и незакрытая колонка чужими шагами не бывают.
  Формой вопроса это не чинится: вопрос законен там, где ответа нет ни в правилах, ни в дереве.
  Список остатков пишется после того, как из него вычеркнуто всё, что исполнитель мог закрыть
  сам.
...
- **Разведка ходом не кончается, сколько бы её ни было.** Переключение ветки, подтягивание,
  просмотр истории и чтение заявок — подготовка к работе: ход, собранный из них одних, оставляет
  работу там же, где она стояла, а выглядит полным — в нём команды, числа и проверяемые ответы.
  Судятся части составной команды по одной: чтение, соединённое с правкой, работой остаётся.
...
- **Признак необратимости берётся из списка, а не выводится доводом.** Список составлен тем, кто
  обратимость уже взвесил. Довод «действие уходит наружу и не откатывается» приходит в контекст
  всегда, а список — только когда его прочитали, и применённый поверх списка довод отменяет
  список целиком — молча, со стороны это выглядит осторожностью. Действия, которого в списке нет, исполнитель на
