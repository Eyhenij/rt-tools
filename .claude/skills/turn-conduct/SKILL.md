...
kind: rule
law: work-conduct
description: Правило под «Закон о ведении работы» — та его часть, что про один ход. Брать, когда ход заканчивают: чем он кончается и что его концом не бывает, что говорится владельцу о чужом шаге, чем подтверждается утверждение о дереве, что делает страж выходов хода, гард ожидания, гард разговора и гард происшествия, как закрывается заход по заполнению окна. Готовый порядок — в паттерне task-flow-handoff. Ход работы от просьбы владельца до слияния — правило task-flow.
---
<!-- rt-kit v0.14.0 · rules/turn-conduct.md · cf7abb5eb8c4 · правится надстройкой, не здесь -->
...
- **Вариант, поданный владельцу, назван ценой для человека.** Сколько шагов, где человек
  окажется и что ему для этого нужно — без этого варианты выглядят равными, и выбор идёт по
  доводам со стороны кода: «меньше путей», «строку запуска не трогаем». Знание, которое делает
  вариант негодным, пишется в сам вариант, а не остаётся у того, кто его составил.
- **Пересказ действующего порядка без оценки читается как одобрение.** На прямой вопрос
  владельца «как это работает» ответ фактами верен и недостаточен: устройство, названное
  спокойно, звучит принятым. Годность порядка для того, кто им пользуется, называется вместе с
  ним.
...
- **Взятая задача — ещё не начатая работа, и ход на ней не кончается.** Ветка по номеру заведена,
  ...
  целиком, потому что работы в нём много — заведение ветки, перевод колонки, уборка соседних
  веток, — и «была ли за ход работа» отвечает не на тот вопрос, что «доведена ли работа до конца
  объявленного состояния». Отчёт при этом встаёт ровно на место следующего действия и выглядит
  завершённым куском лучше всякой другой вехи. Судит это страж отдельным ярусом; ветка без номера
