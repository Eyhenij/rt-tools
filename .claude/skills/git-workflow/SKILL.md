...
---
<!-- rt-kit v0.16.1 · rules/git-workflow.github.md · 0af66c0d5dea · правится надстройкой, не здесь -->
...
- **Личность вызова, открывающего заявку, стережёт гард поставки, а не память исполнителя.** В
  тексте команды она видна только явной подстановкой токена — её гард и требует. Ответ хостинга
  об авторе он спрашивает на снятии черновика: влитую заявку не переоткрыть.
