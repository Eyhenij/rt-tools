...
---
<!-- rt-kit v0.16.1 · rules/git-workflow.github.md · 18fb0ed1b890 · правится надстройкой, не здесь -->
...
- **Ветка следующей работы отводится от предыдущей, пока череда не прервалась.** `git checkout -b
  <КЛЮЧ>-<номер>-<slug> <предыдущая ветка>` вместо `origin/main`: иначе первое же слияние делает
  расходящимися все остальные разом.
