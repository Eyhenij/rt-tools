...
---
<!-- rt-kit v0.17.0 · rules/git-workflow.github.md · 636bf9fab79f · правится надстройкой, не здесь -->
...
- **Волна веток от одной главной проверяется пробным слиянием, а не по одной:** каждая зелена
  сама по себе, а сталкиваются они тем, чего на отдельной ветке не видит ни одна проверка.
...
- **Ветка с открытой заявкой отстаёт от главной молча.** Основание гард судит один раз, в минуту
  открытия, а влитого после прогон не видит: заявка везёт в главную сочетание, которого не
  проверял никто. Отставание считает сверка очереди работ.
...
- **Свои открытые заявки перечитываются перед пушем, при взятии задачи и после каждого
  известного слияния.** Чужое слияние отставляет их все разом; приём — паттерн
