...
---
<!-- rt-kit v0.3.0 · rules/git-workflow.github.md · 33146980444c · правится надстройкой, не здесь -->
...
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| главная ветка                    | `main`                                                                                                                                                                                          |
| отдельная ветка                  | `<КЛЮЧ>-<номер задачи>-<короткий-slug>`; ключ задач — в `implementation.md`. Имя без номера (`feat/…`, `fix/…`) законно, пока ветка живёт локально: PR с неё не откроется                       |
...
| Что                                               | Где                                                      |
| ------------------------------------------------- | -------------------------------------------------------- |
| Выкатка по мержу                                  | `.github/workflows/deploy.yml`                           |
...
| Перевод задачи в другую колонку                   | `tools/board.mjs`                                        |
