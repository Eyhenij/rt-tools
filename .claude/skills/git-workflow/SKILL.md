...
---
<!-- rt-kit v0.16.1 · rules/git-workflow.github.md · 27c60b480278 · правится надстройкой, не здесь -->
...
- **Прогон, вытесненный из очереди конвейера, сверка называет отдельной строкой.** Вытесненный
  выглядит упавшим, хотя ветку не проверял; отличает их число заданий — у него оно ноль.
