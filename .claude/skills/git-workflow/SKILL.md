...
---
<!-- rt-kit v0.24.0 · rules/git-workflow.github.md · 6b4d5e62cf48 · правится надстройкой, не здесь -->
...
- **Условие, известное в начале работы, спрашивается в начале.** Заведение ветки отбивает
  основание без вершины главной и чужую почту в подписи; на пуше то же чинится вливанием с
  конфликтом и переписыванием ветки. Заведение узнаётся и с флагом между глаголом и `-b`:
  `checkout -q -b` — та же форма, и три ветки за один заход прошли мимо гарда именно так.
