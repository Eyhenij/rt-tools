...
---
<!-- rt-kit v0.2.0 · rules/git-workflow.md · bda4be511dcf · правится надстройкой, не здесь -->

# Поставка — каким приёмом

Правило под закон `docs/constitution/delivery.md`. Закон говорит, что должно быть верно; здесь — каким
