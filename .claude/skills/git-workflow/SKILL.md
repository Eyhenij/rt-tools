...
---
<!-- rt-kit v0.16.1 · rules/git-workflow.github.md · 631dbbb09d92 · правится надстройкой, не здесь -->
...
- **Причина исключения, называющая задачу, судится на живость этой задачи.** Мёртвый номер в
  причине делает исключение бессрочным, не сказав об этом ни строкой. Спрашивается тем же
  ярусом, что состояние задачи у гарда поставки: нет сети или доступа — пропускает молча.
