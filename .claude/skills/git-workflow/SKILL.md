...
---
<!-- rt-kit v0.16.1 · rules/git-workflow.github.md · 2359316cfb6a · правится надстройкой, не здесь -->
...
- **Готовность отданной работы живёт до следующего слияния в главную.** Влитая соседняя заявка
  делает свою конфликтующей, а сказанное час назад «доведено до ready» продолжает читаться как
  действующее. После каждого слияния сливаемость своих открытых заявок спрашивается заново — одним
  вызовом на все, а не по той, чья ветка сейчас взята.
