...
---
<!-- rt-kit v0.17.0 · rules/git-workflow.github.md · 99ab6b39ba09 · правится надстройкой, не здесь -->
...
- **Связь задачи с эпиком сверка читает в обе стороны.** Односторонняя привязка выглядит целой
  так же, как двусторонняя: читатель приходит то от линии работ, то от карточки. Держалась она
