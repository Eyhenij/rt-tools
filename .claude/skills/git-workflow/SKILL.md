...
---
<!-- rt-kit v0.8.1 · rules/git-workflow.github.md · 78bf375d1e00 · правится надстройкой, не здесь -->
...
- **Мерж PR нажимает человек, а не исполнитель работы.** Кнопка и вызов слияния равны: запрет
  на них один. Исполнитель сливает свой отчёт только тогда, когда человек сказал это прямо и про
  этот отчёт; сказанное об одном отчёте на следующий не переносится, а молчание разрешением не
