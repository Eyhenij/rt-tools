...
---
<!-- rt-kit v0.21.0 · rules/git-workflow.github.md · 9f3e27e488de · правится надстройкой, не здесь -->
...
- **Утверждение о главной ветке делается по удалённой ссылке, а не по локальной.** Локальная
  протухает в минуту, когда её подтянули, и молчит об этом. Сравнение пишется от `origin/main`
  целиком: смешанные в одной команде, они дают промах, изнутри выглядящий верным.
