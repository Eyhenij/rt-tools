...
---
<!-- rt-kit v0.17.0 · rules/git-workflow.github.md · b7ee71b047df · правится надстройкой, не здесь -->
...
- **Рабочее дерево не опустошается ради прогона инструмента.** Сравнение с прежним состоянием
  делается на второй копии дерева. Прятанье уводит незакоммиченную работу туда, где её не видит ни
  состояние дерева, ни сверка, а команда, прошедшая между прятаньем и возвратом, делает возврат
  конфликтным.
