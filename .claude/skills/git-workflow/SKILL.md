...
---
<!-- rt-kit v0.14.0 · rules/git-workflow.github.md · 74469eaaf190 · правится надстройкой, не здесь -->
...
- **Черновик не снимается с ветки, которая не сливается.** Зелёный прогон говорит «не сломано»,
  сливаемость — «кнопку можно нажать», и владельцу нужно второе. Спрашивается это у хостинга тем
  же вызовом, что автор и ревьювер: `mergeable` приходит в том же ответе. Выводить сливаемость
  из локального вливания нельзя — между ним и взглядом владельца главная уходит вперёд, и за
  один заход так было снято три черновика, все три заявки владелец увидел конфликтующими.
  Держится это гардом поставки, а не памятью. Дерево, чей помощник очереди работ о сливаемости
  не говорит, работает как прежде — поля нет, требования нет.
