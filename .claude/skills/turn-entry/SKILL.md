...
---
<!-- rt-kit v0.10.0 · rules/turn-entry.md · c758b7eda41b · правится надстройкой, не здесь -->
...
- `task-flow-handoff` — закрытие захода: точка остановки, форма передачи и её обратная сторона.
