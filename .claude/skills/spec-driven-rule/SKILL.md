...
---
<!-- rt-kit v0.3.0 · patterns/spec-driven-rule.md · ed08f04c6582 · правится надстройкой, не здесь -->
...
`docs/constitution/<закон>.md`. О проекте не знает ничего: ни путей, ни имён файлов, ни привязок.
...
`.claude/skills/<правило>/SKILL.md`. Говорит, каким приёмом закон исполняется; на один закон их
бывает несколько.
