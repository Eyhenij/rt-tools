...
---
<!-- rt-kit v0.16.1 · patterns/spec-driven-rule.md · 09336a1e8046 · правится надстройкой, не здесь -->
...
Ресурсы называются именами пакета, а не путями дерева: у потребителя они лежат там, где он их
разложил. Требования нет — строки нет вовсе; пустой она не бывает. Выводить его из фразы в
тексте нельзя: разложено у потребителя не всё, и сказанное безусловно — «правку до этого
отбивает гард» — врёт в дереве, где того гарда не разложили.
