...
| Что                              | Где                                                                          |
| -------------------------------- | ---------------------------------------------------------------------------- |
| набор правил кода                | `eslint.config.mjs` в корне                                                  |
...
| --------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Род объявления виден по префиксу имени, и это держат правила линтера. | Здесь держится договорённостью, а не линтером: правила имён в `eslint.config.mjs` нет. Приставка `I` у интерфейсов и суффикс `_ENUM` у перечислимых наборов выдержаны по дереву, но нарушение поймает только разбор. |
