...
---
<!-- rt-kit v0.16.1 · patterns/task-flow-archive.md · cb5d5d6a9baa · правится надстройкой, не здесь -->
...
находки принимаются одним ходом — записать и продолжить прежнее, а владельцу о них говорится,
когда кончился эпик.
