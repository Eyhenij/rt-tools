...
description: Правило этого дерева про оформление китов: порог узкого экрана и три его рода, токены и ручки тем, своё свойство компонента между ступенью и местом, тёмная тема и контраст, старшинство состояния над оформлением, класс блока против директивы, слой каскада у правил кита и сборка слоя оформления. Брать при правке любого *.scss китов и их шаблонов вместе с правилом styling-bem: то говорит приёмом закона, это — именами и числами этого дерева.
---
