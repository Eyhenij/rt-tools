...
- **Правило, спорящее с неслоевым правилом чужой библиотеки, объявляется вне слоя и говорит об этом при себе.** — `projects/ui-kit-v2/src/lib/components/aside/rt-aside-overlay.styles.spec.ts:split` — проба над собранным CSS делит его на слоевую и внеслоевую половины и судит, что в какой стоит. Проверка слоя каскада вынесенного не видит: она судит число обёрток и правила до первой
