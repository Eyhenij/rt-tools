...
| У каждого класса элемента есть своё правило стилей.                                 | **Не проверяется ничем** в этом дереве: проверка классов вёрстки судит приложение, которого здесь нет. Класс без правила синтаксически законен; ловится разбором и показом состояния на витрине.                                                                                                                                                                   |
...
| Раскладка объявлена в общем слое приложения, а не в стилях экрана.                  | **Не применимо.** Приложения с экранами в этом дереве нет. Общий слой — `projects/ui-kit-v2/src/styles/`, туда уходят точки перелома, тема и мост к Material; файл стилей компонента держит только его собственные отличия.                                                                                                                                        |
