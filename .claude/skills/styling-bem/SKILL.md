...
---
<!-- rt-kit v0.24.0 · rules/styling-bem.md · d55d5b8a318c · правится надстройкой, не здесь -->
...
- **Одна вещь называется одним именем во всех местах, где она встречается.** Раскладка, у которой
  ...
  общим слоем не считается: место объявления совпадает, а значение имени — нет. Выбирая имя,
  исполнитель попадает в чужой словарь и приносит чужой отступ, а проверки этого не видят. Место,
  где элемент стоит, задаётся видом блока, а не вторым набором имён.
