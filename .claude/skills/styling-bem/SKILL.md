...
---
<!-- rt-kit v0.20.0 · rules/styling-bem.md · fee8934f07cd · правится надстройкой, не здесь -->
...
- **Предел ширины объявляется вместе с судьбой не влезшего.** Предел и место в строке сами по
  ...
  границы и ложится поверх соседа, а разрешение элементу сжаться обрезкой не является.
  <!-- rt-when: *.scss *.css -->
