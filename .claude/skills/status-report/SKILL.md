...
kind: rule
law: work-conduct
description: Правило под «Закон о ведении работы». Брать, когда владелец спросил, где работа стоит, — «какой статус», «что за эпик», «что за задача», «что сейчас делаешь». Называет форму ответа — абзац об эпике и под ним таблицу со всеми его задачами по назначенному порядку — и то, чем каждая клетка о состоянии дерева подпирается. Готовые вызовы и образец — в паттерне status-report-table.
---
<!-- rt-kit v0.14.0 · rules/status-report.md · 0f2570f9a9bd · правится надстройкой, не здесь -->
