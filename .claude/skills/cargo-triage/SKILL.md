...
Что груз прочитан, машина видит; что он разобран — нет, и проверки на это не будет: признака
«прочитал и решил» у исполнителя не существует. Гард видел бы только вызов команды, а вызов без
разбора ничем не отличается от вызова после него.
