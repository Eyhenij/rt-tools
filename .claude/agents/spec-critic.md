...
---
<!-- rt-kit v0.24.0 · agents/spec-critic.md · 82f6887dda40 · правится надстройкой, не здесь -->
...
- **Обещание, которое нечем проверить.** «Быстро», «удобно», «понятно» сценарием не
  закрываются.
- **Недостижимое «Дано».** Состояние, с которого сценарий начинается, приложение должно уметь
  принять. Проверяется это только чтением кода, и дешевле сделать это до того, как по
  договорённости написан код: сценарий эпика описывал переход, которого в приложении нет, и
  дожил до минуты, когда его сели снимать. Недостижимое «Дано» снимает сценарий целиком.
