...
---
<!-- rt-kit v0.8.2 · agents/rules-reviewer.md · 3739651912c7 · правится надстройкой, не здесь -->
...
- **«Чего из закона здесь нет»** — его не читает ни одна сверка, и неправда живёт в нём сколько
  угодно: правило три задачи подряд писало, что механизма в дереве нет, а он был.
