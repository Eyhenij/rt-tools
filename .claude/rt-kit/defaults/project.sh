#!/usr/bin/env bash
# rt-kit v0.23.0 · defaults/project.sh · 90937fe1c068 · правится надстройкой, не здесь
...
# стоит одного вызова, но знает, как спрашивать, только дерево: хостинг, клиент и путь к токену
...
# удалось» — гард на нём пропускает вызов и говорит об этом вслух.
rt_pull_token_login() { :; }
