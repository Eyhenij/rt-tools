#!/usr/bin/env bash
# rt-kit v0.26.0 · defaults/project.sh · 86d35a57705b · правится надстройкой, не здесь
...
rt_push_checks_default() {
    ...
    for check in check-doc-paths check-specs check-file-size check-dupes check-styles \
        ...
        check-turn-map check-spec-coverage check-archive-age check-profile-drift check-hook-scope check-push-gate; do
