#!/usr/bin/env bash
# rt-kit v0.23.0 · defaults/shell.sh · e7f2ed3e8702 · правится надстройкой, не здесь
...
rt_shell_writes_default() {
    ...
    # бывает. Прежде судило само имя, и заход, гонявший проверку ради диагностики, получал
    # требование правила общего кода, ничего в нём не правя; за две задачи таких отбитий
