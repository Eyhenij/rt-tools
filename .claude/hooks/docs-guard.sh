#!/usr/bin/env bash
# rt-kit v0.2.0 · hooks/docs-guard.sh · 99c125dba702 · правится надстройкой, не здесь
...
# профиль проекта: .claude/rt-kit/project.sh, функция `rt_docs_pair_for <файл>` — печатает образец
