#!/usr/bin/env bash
# rt-kit v0.8.1 · hooks/git-guard-delivery.sh · e4fd042a95d8 · правится надстройкой, не здесь
...
# так открытый отчёт и оказался конфликтующим, и узнал об этом владелец.
#
