 ...
 * работу, и запрос к хранилищу в его конструкторе поднимался бы вместе с составом команд деревьев,
 * где ни порта, ни входа нет вовсе.
 */
...
export class AccountStartupService implements OnApplicationBootstrap {
    ...
    public async onApplicationBootstrap(): Promise<void> {
        ...
        if (counted === 0) {
            this.#log.warn('учётных записей нет ни одной: первая заводится экраном первичной настройки по адресу админки');
        }
    }
}
