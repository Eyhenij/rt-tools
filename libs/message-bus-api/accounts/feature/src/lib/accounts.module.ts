 ...
 * решение домена.
 *
 * Состав команд деревьев этот модуль не берёт: там нет ни порта, ни входа, и говорить о записях
 * при подъёме было бы некому — эта строка о них и говорит.
 */
@Module({
    controllers: [
        SetupController,
        AuthController,
        AccountsReadController,
        AccountsManageController,
        AccountsAccessController,
        RolesController,
    ],
