...
export default defineConfig(() => ({
    root: __dirname,
    cacheDir: '../../../../node_modules/.vite/libs/message-bus-admin/proposals/ui',
    ...
    // },
    test: {
        name: 'message-bus-admin-proposals-ui',
        watch: false,
        ...
        reporters: ['default'],
        coverage: {
            reportsDirectory: '../../../../coverage/libs/message-bus-admin/proposals/ui',
