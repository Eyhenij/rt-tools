...
export class AdminSetupComponent {
    ...
    protected readonly fault: IAdminFaultText = adminFaultText('setupFailed');

    /** Был ли отказ. Сам текст приходит из словаря и меняется с языком, а признак держится здесь. */
