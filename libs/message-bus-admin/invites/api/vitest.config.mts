...
export default defineConfig(() => ({
    root: __dirname,
    cacheDir: '../../../../node_modules/.vite/libs/message-bus-admin/invites/api',
    ...
    // },
    test: {
        name: 'message-bus-admin-invites-api',
        watch: false,
        ...
        reporters: ['default'],
        coverage: {
            reportsDirectory: '../../../../coverage/libs/message-bus-admin/invites/api',
