...
export default defineConfig(() => ({
    root: __dirname,
    cacheDir: '../../../../node_modules/.vite/libs/message-bus-admin/chat/shell',
    ...
    // },
    test: {
        name: 'message-bus-admin-chat-shell',
        watch: false,
        ...
        reporters: ['default'],
        coverage: {
            reportsDirectory: '../../../../coverage/libs/message-bus-admin/chat/shell',
