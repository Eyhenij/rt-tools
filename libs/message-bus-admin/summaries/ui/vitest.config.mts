...
export default defineConfig(() => ({
    root: __dirname,
    cacheDir: '../../../../node_modules/.vite/libs/message-bus-admin/summaries/ui',
    ...
    // },
    test: {
        name: 'message-bus-admin-summaries-ui',
        watch: false,
        ...
        reporters: ['default'],
        coverage: {
            reportsDirectory: '../../../../coverage/libs/message-bus-admin/summaries/ui',
