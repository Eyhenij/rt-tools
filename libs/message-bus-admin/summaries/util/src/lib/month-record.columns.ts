 ...
 *
 * Набор повторяет тот, что принимает приёмник: поле не из него он отбивает отказом. Счёта
 * заходов здесь нет — приёмник им не упорядочивает.
 */
export const SUMMARIES_SORTABLE: readonly string[] = ['ranAt', 'month', 'tree'];
