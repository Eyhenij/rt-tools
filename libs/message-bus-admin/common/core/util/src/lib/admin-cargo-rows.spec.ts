...
describe('adminStatedRows', () => {
    ...
    it('SC-MB-404 — слово состояния идёт за выбором языка, а не остаётся на прежнем', () => {
        ...
        // Слово состояния есть в обоих наборах, и на английском выборе приходит английское:
        // подпись пересчиталась, а не осталась на прежней.
        expect(words()[0].stateLabel).toBe('In work');
    });
});
