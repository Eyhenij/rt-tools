...
export const ADMIN_LABELS = {
    ...
    hintInvites: 'Чем дерево заводит себя само. Выдаётся здесь же кнопкой «Пригласить дерево»',
    ...
    inviteCreate: 'Пригласить дерево',
    inviteCreateTitle: 'Приглашение дереву',
    inviteCreateName: 'Имя будущего дерева',
    inviteCreateNameHint: 'По нему дерево будет видно в списках. Сменить его потом нельзя.',
    ...
    listEmptyInvitesFrom: 'Выдаются кнопкой «Пригласить дерево» над списком',
