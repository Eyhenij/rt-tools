...
export default defineConfig(() => ({
    root: __dirname,
    cacheDir: '../../../../node_modules/.vite/libs/message-bus-admin/usage/util',
    ...
    // },
    test: {
        name: 'message-bus-admin-usage-util',
        watch: false,
        ...
        reporters: ['default'],
        coverage: {
            reportsDirectory: '../../../../coverage/libs/message-bus-admin/usage/util',
