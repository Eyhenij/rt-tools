<!-- rt-kit v0.22.0 · docs/GLOSSARY.md · 2fcd88176a0d · правится надстройкой, не здесь -->
# Словарь проекта
...
- **Постмортем** — запись о происшествии в приёме груза: механизм промаха по шагам, что было доступно до него, чем ловилось и что из этого ушло в слой правил
