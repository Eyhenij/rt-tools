<!-- rt-kit v0.8.3 · docs/GLOSSARY.md · e80657ca9538 · правится надстройкой, не здесь -->
# Словарь проекта
...
| Заявка         | Обращение дерева к приёму за токеном: приглашение и признак дерева. Имени в ней нет — его приём берёт из приглашения                            |
