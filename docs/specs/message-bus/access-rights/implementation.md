...
- **The rights are given by the same change that closed the operations.** — `prisma/migrations/20260910100000_grant_rights_to_existing_accounts/migration.sql:roleId` — and `prisma/migrations/20260914210000_grant_usage_read/migration.sql:rights` for the right of the usage section
