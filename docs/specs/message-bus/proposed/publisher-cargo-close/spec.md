...
**Статус:** предложено · **Ревизия:** 2026-08-28 · **Префикс сценариев:** `SC-MB`
...
| ---------------- | ------------------------------------------------------- |
| закрытие записи  | `node tools/cargo-close.mjs --state fixed --proposal …` |
...
- 2026-08-28 — договорённость заведена.
