...
Покрытие: частичное — строку списка с версией закрывает спека чтения принятого, а столбец на экране закрывает сквозная спека четвёртого этапа.
...
Покрытие: частичное — пустую версию в строке списка закрывает спека чтения принятого, а вид ячейки закрывает сквозная спека четвёртого этапа.
...
Покрытие: частичное — три отбора в полосе закрыты спеками обоих разделов, а вид на экране закрывает сквозная спека четвёртого этапа.
...
Покрытие: частичное — набор версий закрыт спекой операции, а список выбора на экране закрывает сквозная спека четвёртого этапа.
...
Покрытие: частичное — решение закрыто спекой общей либы, а путь человека закрывается сквозной спекой четвёртого этапа.
...
Покрытие: частичное — сброс страницы закрыт спекой раздела разборов, а путь человека закрывает сквозная спека четвёртого этапа.
...
Не покрыто: экран раздела ещё не правлен — это третий этап работы, а путь человека закрывает четвёртый.
...
Покрытие: частичное — порядок закрыт спеками общей либы и чтения принятого, а путь человека закрывает сквозная спека четвёртого этапа.
...
Покрытие: частичное — отсутствие обоих отборов у сводок закрыто спекой раздела, а вид на экране закрывает сквозная спека четвёртого этапа.
...
Покрытие: частичное — ответ операции закрыт её спекой, а запрос экрана закрывает сквозная спека четвёртого этапа.
