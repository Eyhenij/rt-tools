...
что лежит в записи месяца и в каком месте приём обязан отказать вместо молчания. Учётных
записей, входа и админки спек пока не описывает: их у приёмника нет.
