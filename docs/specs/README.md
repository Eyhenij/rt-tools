...
шторка, колонка сортировки и исход быстрых повторных вызовов. Рядом поддомен о втором уровне
бокового меню: мода подменю, закреплённая панель и поиск по подменю. Поверхностей остальных
компонентов и служб спек пока не описывает.
