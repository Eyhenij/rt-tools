...
после входа — четыре раздела админки со списком, отбором по дереву и панелью подробностей. Там же
— где приёмник стоит: имя и защищённая дорога, подъём готового образа по sha, проба живости как
признак удавшейся выкатки и дамп, которым узел переживают.
