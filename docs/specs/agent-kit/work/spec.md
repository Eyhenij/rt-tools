...
Поверхность — две команды строки запуска и один гард. Заведение задачи делает четыре шага —
...
- 2026-08-18 — сверка очереди работ спрашивает прогон на вершине каждого открытого PR: вершина,
  за которой прогон не встал, перестала быть неотличимой от зелёной.
