...
### SC-AK-620 — команда ничего не пишет

Дано дерево с разложенным слоем правил
Когда команда счёта отработала
Тогда ни один файл дерева не изменился

Не покрыто: команда ещё не написана.

### SC-AK-621 — без доступа к счёту команда отказывает, а не считает приблизительно

Дано доступа к счёту токенов на машине нет
Когда команда счёта зовётся
Тогда она называет, чем доступ заводится, ничего не печатает числом и даёт ненулевой код

Не покрыто: команда ещё не написана.

### SC-AK-622 — наружу уходит только счёт токенов

Дано дерево с разложенным слоем правил
Когда команда счёта отработала
Тогда единственные вызовы наружу — счёт токенов, и других адресов среди них нет
