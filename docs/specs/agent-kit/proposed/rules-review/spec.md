...
- **Набор разделов объявлен на род и назван поимённо, а не выведен из образца.** Образец рода —
  черновик для того, кто заводит ресурс, и корпусу он не хозяин: сегодня образец правила
  объявляет раздел «Когда берётся», которого нет ни в одном из двадцати шести файлов правил, а
  все двадцать шесть несут три раздела, о которых образец молчит. Наборы такие:
