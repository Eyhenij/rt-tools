...
вовсе. Подтверждаются они двумя способами, и у каждого сценария записано, каким именно: то, что
видно снаружи, — вызовом на живой семье; то, что видно только в ответе роли, — чтением этого
ответа. Заводить им тест значило бы проверять, что в файле стоят нужные слова, — зелёный такой
тест не говорит ничего о том, как роль прочитает семью.
