...
### SC-AK-152 — замещённый раздел пакета назван в снимке по имени
...
### SC-AK-153 — свой раздел уезжает числом, а не именем
...
### SC-AK-154 — невыбранный ресурс виден в снимке отдельно от надстроенного

Дано дерево сняло ресурс списком отказов
Когда берётся снимок надстроек
Тогда ресурс назван невыбранным, а не отсутствует в снимке молча

### SC-AK-155 — содержимое надстройки в снимок не попадает
...
### SC-AK-156 — наблюдение несёт признак дерева, по которому адрес не восстановить
...
### SC-AK-157 — две рабочие копии одного репозитория дают один признак
...
### SC-AK-158 — дерево без удалённого репозитория берёт признак из настройки
