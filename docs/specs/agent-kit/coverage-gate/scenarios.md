...
### SC-AK-1058 — full coverage lets the push through
...
### SC-AK-1059 — an uncovered resource refuses the push
...
### SC-AK-1060 — a tree without package directories is not judged
...
### SC-AK-1061 — a tree without the entry into the specs is not judged
