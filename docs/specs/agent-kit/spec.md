...
- **Блок** — предложение, записанное в файл: заголовок с адресом и ресурсом, место, повод и
  готовый текст.
...
повод и — после отправки — ссылка на заведённую запись. Кладут его два движения — разбор
