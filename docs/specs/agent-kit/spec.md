...
- **Открытый отчёт, чья ветка везёт папку своей задачи, — расхождение сверки.** Гард судит
  ...
  отдельной задачей. Судится ветка отчёта, а не рабочее дерево.
- **Строка обхода начинает строку и подстановки не принимает.** Иначе обход снимает
  ...
  тело отчёта о правке гарда, и сам отказ гарда. Приёмка такого признака осталась зелёной там,
