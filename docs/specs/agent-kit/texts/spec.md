...
- **У текста есть адресат, и слог выбирается по нему, а не по тому, что писалось до него.** Текст,
  написанный сразу за правкой спеки, наследует её слог молча: изнутри он читается хорошо
  написанным, а пустым оказывается для того, кто его читает.
- **Команда, публикующая тело задачи или заявки, требует правило слога.** Этот текст файлом дерева
  не становится вовсе, и гейт, судящий расширение правимого файла, на нём молчал.
