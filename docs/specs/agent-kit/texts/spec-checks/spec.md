...
- **Заголовок раздела привязок и вердикт «не исполняется» читаются под двумя именами,
  английским и русским.** Компаньоны дерева переводятся своей задачей и по одному, а сверка
  гоняется на всех сразу: одно имя означало бы, что до конца перевода она красная у половины
  правил. Хватает любого из двух имён; отказ об отсутствии раздела называет английское.
