...
**Статус:** действует · **Ревизия:** 2026-09-01 · **Префикс сценариев:** `SC-AK`
**Зависимости:** нет
**Законы:** `delivery`
**Процедуры:** нет
...
- **Спрашивает дерево, а не пакет.** Хостинг, клиент и путь к токену у каждого свои; пакет держит
  сверку ответа с машинной записью и ничего не знает о том, как его получить.
- **Пустой ответ работу не заклинивает и называется вслух.** «Спросить не удалось» и «сверка
  сошлась» молчат одинаково, поэтому пропуск говорит о себе строкой.
