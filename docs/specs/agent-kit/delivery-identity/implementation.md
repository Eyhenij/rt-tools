...
- **Черновик не снимается с заявки, открытой не машинной записью.** — `projects/agent-kit/assets/hooks/git-guard-delivery-draft.sh:pull_author`
- **Отказ на снятии черновика называет обе записи и переоткрытие.** — `projects/agent-kit/assets/hooks/git-guard-delivery-draft.sh:pull_author`
