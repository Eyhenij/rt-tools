...
- **Команда линтера, не назвавшая правленый файл, называется словом, а не отбоем.** — `projects/agent-kit/assets/hooks/lint-after-edit.sh:path_gap` — сценарий SC-AK-885
...
- **Ошибаться признак обязан в сторону лишнего срабатывания.** — Не проверяется: это довод выбора образца, записан в комментарии рядом с ним.
