...
### SC-AK-327 — выключенный деревом экзаменатор правку пропускает
...
### SC-AK-328 — выключенная соседняя роль экзамен не отменяет
...
### SC-AK-329 — настройка, которую не разобрать, роль не выключает
