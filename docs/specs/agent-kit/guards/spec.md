...
Сюда же входит то, что гарды требуют от захода: прочитанные правила перед вопросом владельцу,
запись о происшествии после признания промаха, выбранная точка остановки до конца окна.
