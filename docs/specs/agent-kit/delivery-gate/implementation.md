...
- **Машинный коммит опознаётся по заявке, а не по почте.** — `projects/agent-kit/assets/hooks/git-guard-delivery-signature.sh:bot_login`
...
- **Подпись читается на машине, без сети.** — `projects/agent-kit/assets/hooks/git-guard-delivery-signature.sh:strangers`
- **Отказ по подписи называет коммит поимённо и обе почты.** — `projects/agent-kit/assets/hooks/git-guard-delivery-signature.sh:strangers`
