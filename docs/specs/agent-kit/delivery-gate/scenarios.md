...
### SC-AK-948 — the epic of a task is declared by one shape, and it is read in one place
...
### SC-AK-949 — the state of a task carries the number of its epic
...
### SC-AK-950 — the branch of a task is taken from the branch of its epic
...
### SC-AK-951 — the request of a task of an epic goes into the branch of the epic
...
### SC-AK-952 — the request of an epic waits for the folders of its tasks to be taken apart
