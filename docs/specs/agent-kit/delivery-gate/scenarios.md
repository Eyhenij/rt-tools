...
Когда гард отбивает пуш
Тогда отказ называет три хода: починить названное, починить саму проверку — разбор поимённо и
показ разбора владельцу, — либо принести владельцу цену обхода. Список известного при этом назван
не тем ходом: он копит принятое, а не показания сломанного прибора
