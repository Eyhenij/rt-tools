...
- **Отказ гейта пуша называет три хода, а не два.** Красное бывает двух родов, и по коду возврата
  они неотличимы: когда врёт сама проверка, «почини и пушь снова» велит чинить код, которого никто
  не трогал. Третий ход — разбор отказа поимённо, показ разбора владельцу и правка самой проверки.
- **Спорное в список известного не вносится.** Список копит принятое, а не показания сломанного
  прибора.
