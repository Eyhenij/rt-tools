...
- **The word of the owner about a stop lifts the refusal, and the guard reads it from them.** — `projects/agent-kit/assets/hooks/turn-exit-verdict.sh:told_stop` — the owner remark is judged, not the reply text; scenario `SC-AK-1014`
