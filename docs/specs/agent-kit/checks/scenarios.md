...
### SC-AK-333 — несошедшиеся условия поставки называются одним отказом
...
### SC-AK-337 — заведение ветки отбивает основание без вершины главной
...
### SC-AK-338 — ветка от свежего основания заводится
...
### SC-AK-339 — заведение ветки отбивает чужую почту коммитов
...
### SC-AK-340 — совпавшая и необъявленная почта заведение ветки не задерживают
...
### SC-AK-353 — ветка от названного свежего основания заводится
...
### SC-AK-354 — ветка от отставшего основания отбита
...
### SC-AK-355 — отставшая локальная ссылка отбивает заведение ветки
...
### SC-AK-356 — молчание опроса заведение ветки не задерживает
