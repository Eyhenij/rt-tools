...
- **Заявка, открытая не в главную ветку, называется своей строкой.** Прогона у неё не будет
  никогда: рабочий поток слушает заявки в главную и событий про другую базу не видит вовсе.
  Строка о потерянном событии врала бы дважды — событие не терялось, и перезакрытие его не
  вернёт; лечится это переносом базы после того, как нижняя заявка влита.
