...
- **Отказ по ненайденному адресу приёма называет, у кого его спросить.** Ключ настройки отвечает
  на «куда вписать» и молчит о том, откуда взять: адреса пакет не знает — приём поднимает владелец,
  и у каждой мастерской он свой. Исполнитель с готовым грузом и кодом приглашения на руках дважды
  упирался в этот отказ и оба раза не мог сделать ничего, кроме как спросить владельца, — а того,
  что спрашивать надо именно адрес и именно у него, ему не сказал никто.
