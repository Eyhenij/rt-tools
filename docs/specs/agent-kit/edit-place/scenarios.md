...
Дано команда зовёт интерпретатор и подаёт ему тело, в котором разложенный файл только читается
Когда гард судит команду
Тогда правка проходит; тело с вызовом записи отбивается по-прежнему, в том числе когда путь стоит
