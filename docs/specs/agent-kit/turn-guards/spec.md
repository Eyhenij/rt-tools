...
- **Ход, в котором у владельца просят войти или ввести пароль, не заканчивается.** Стенд, вход и
  данные для проверки готовит агент; препятствие перед просьбой — отбитое классификатором поле,
  чужое расширение в браузере, отключившийся профиль — остаётся препятствием агента. Требование
  держалось памятью исполнителя и не удержало: за один заход просьба прозвучала четырежды подряд.
- **Просьба о режиме работы законна и отбою не подлежит.** У владельца просят обычный режим
  вместо автоматического; ввод в форму делает агент. Гард, не различающий эти две просьбы,
  запретил бы единственный законный ход.
- **Граница набора образцов названа вслух.** Просьба словами вне набора и просьба, поданная меню
  вариантов, гарду не видны.
