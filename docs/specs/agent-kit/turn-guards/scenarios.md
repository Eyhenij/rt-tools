...
### SC-AK-406 — «проверено» без прогона набора ход не закрывает
...
### SC-AK-407 — «запушено» без вызова пуша ход не закрывает
...
### SC-AK-400 — вызов удаления «ветки сняты» подтверждает
...
### SC-AK-401 — поиск по дереву отрицание подтверждает
...
### SC-AK-402 — обещание проверить ход не задерживает
...
### SC-AK-403 — те же слова в выводе инструмента ход не задерживают
...
### SC-AK-404 — повторный заход по тому же ходу не судится
...
### SC-AK-405 — отказ называет найденное утверждение
