...
Covered: `projects/ui-kit-v2/rich-editor/src/lib/components/chat/rt-chat-message-actions.directive.spec.ts`.
...
Covered: `projects/ui-kit-v2/rich-editor/src/lib/components/chat/rt-chat-message-actions.logic.spec.ts`,
`projects/ui-kit-v2/rich-editor/src/lib/components/chat/rt-chat.component.spec.ts`.
