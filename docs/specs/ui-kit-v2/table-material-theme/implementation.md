...
- **The fill search of the list is 52 px high.** — `projects/ui-kit-v2/src/lib/components/data-list/toolbar/rt-data-list-toolbar.component.ts:searchSize` — scenario `SC-UKV-356`
