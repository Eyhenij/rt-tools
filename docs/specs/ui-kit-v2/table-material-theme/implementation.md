...
- **The fields of the filter row are the first kit's outlined Material field in the material preset.** — `projects/ui-kit-v2/src/styles/tokens.material.mjs:rt-list-filter-field-height` — no scenario: the look is held by a measurement against the first kit
