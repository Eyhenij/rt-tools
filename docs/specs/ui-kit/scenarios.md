...
и меряет ширину узлом, а не считает её сам. Замер в обычном браузере: полоса 6 пикселей у обоих
списков, дорожка `light-dark(#f5f6f8, #232226)`, ползунок `light-dark(#ccc, #4a494e)`.
