...
### SC-UK-40 — пункт подменю занимает ширину панели

Дано подменю, ширина которого меняется — тягой за край и работой с полем поиска
Когда панель становится шире или уже
Тогда пункт идёт за ней и занимает её ширину, а не своё число: панель, выросшая вдвое, держала бы
иначе обрезанные подписи при пустой полосе справа. Своё число остаётся у пункта нижним пределом
там, где потребитель включил боковую прокрутку списка, — сжатый пункт прокручивать нечем

Не покрыто: ширину держит оформление, а стили компонента в спеке не применяются — ширина пункта
там равна нулю. Снято замером в браузере: панель 240 — пункт 222, панель 480 — пункт 462, и то же
на заголовке раскрывающегося раздела; у пункта с боковой прокруткой нижний предел остался 220.
