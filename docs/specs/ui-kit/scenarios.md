...
### SC-UK-38 — выбранная тягой ширина заменяет заданную оформлением

Дано потребитель задал ширину подменю своим оформлением
Когда человек тянет край панели влево, уже этой ширины
Тогда панель сужается за указателем и останавливается на нижнем пределе кита: ширина от
оформления — умолчание до первой тяги, а не пол под ней. Тяга вправо расширяет панель, как прежде

Не покрыто: ширину держит оформление компонента, а в спеке стили не применяются — ширина панели
там равна нулю. Снят замером в браузере: заданная оформлением ширина 272 пикселя, тяга вправо
даёт 372, тяга влево — 150
...
### SC-UK-49 — закреплённой панели нечего показать: места она не занимает
...
### SC-UK-50 — нажатие пункта полосы переставляет закреплённое подменю
...
### SC-UK-51 — переход на страницу без разделов снимает закреплённое подменю
