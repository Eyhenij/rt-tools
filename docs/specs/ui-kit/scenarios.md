...
### SC-UK-31 — закреплённое и незакреплённое подменю помечены разными значками

Дано подменю показано в обеих модах
Когда человек смотрит на переключатель
Тогда закреплённое помечено залитой булавкой, незакреплённое — контурной, и разница берётся
семейством значка: ось переменного шрифта читает не всякий набор, зарегистрированный
потребителем, и на статическом оба состояния рисуются одним глифом
...
### SC-UK-37 — подменю не бывает уже ширины, заданной оформлением
...
Покрыто: замером в браузере — заданная оформлением ширина 240 пикселей, тяга влево оставляет 240,
тяга вправо даёт 358.
