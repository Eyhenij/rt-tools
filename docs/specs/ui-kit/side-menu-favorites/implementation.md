...
- **The hollow star and the remove button show on hover and on keyboard focus of their row; the filled star always shows.** — `projects/ui-kit/src/lib/ui-kit/side-menu/menu-sub-item/rtui-side-menu-sub-item.component.scss:__favorite`
