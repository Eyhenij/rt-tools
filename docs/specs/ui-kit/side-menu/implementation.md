...
- **The filter goes down into the folders of the submenu, and a folder stays by two different occasions.** — `projects/ui-kit/src/lib/ui-kit/side-menu/side-menu.logic.ts:filterSubMenuItems`
