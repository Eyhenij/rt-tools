...
- **Состояние:** `этап-идёт`
- **Этап:** 1 из 3 — Признак читается у заголовка heredoc
- **Сделано:** разбор просьбы и замысел написаны, папка заведена в историю
- **Следующий шаг:** правка признака в разборе путей
- **Незакоммиченное:** нет
- **Ждём владельца:** нет
- **PR:** ещё не открыт
