...
- [ ] 3.1 The settings field `favoritesCollapsed` read and kept by the settings logic
- [ ] 3.2 The service gives the collapsed ids and writes the state of one section
- [ ] 3.3 The block title becomes a toggle with a chevron, labels and the count
- [ ] 3.4 Styles of the toggle and the chevron column
- [ ] 3.5 Tests for the logic, the service and the block
- [ ] 4.1 The menu input `favoriteActionsReserve` and its host mark
- [ ] 4.2 Styles of the star, the remove button and the handle without the reserve
- [ ] 4.3 Tests for the mark
