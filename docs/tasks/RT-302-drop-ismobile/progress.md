...
- **Состояние:** `этап-идёт`
- **Этап:** 3 из 3 — запись выпуска
- **Сделано:** вход снят у семнадцати компонентов, `narrow` читает только службу, истории
  витрины переведены на рамку кадра, спека пагинации переписана, журнал получил раздел
  ломающих изменений
- **Следующий шаг:** дождаться общего прогона и закоммитить
- **Незакоммиченное:** правка кита, витрины, журнала, правила и замысла
- **Ждём владельца:** нет
