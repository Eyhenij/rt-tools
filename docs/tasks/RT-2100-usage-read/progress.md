...
- Closing: scenarios SC-MB-343…347 marked covered, two of them partial until the end-to-end spec; the reading rules bound; the admin operations table and the rights binding name the new operations and the migration.
