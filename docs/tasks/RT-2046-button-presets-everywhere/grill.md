...
## The owner added along the way

> на сторьке кнопок темы нет кнопок материал, проверь все сторьки

История `Themes` показывала палитру в двух темах и одном наборе. Пара тем и пара наборов —
два разных показа, и обёрнутая одна в другую они дают четыре вида: свой набор в светлой и
тёмной теме, материальный в светлой и тёмной. Ровно столько видов у кита с одним набором и
есть — тёмная тема сильнее набора, и имя, о котором она молчит, берёт значение набора.
