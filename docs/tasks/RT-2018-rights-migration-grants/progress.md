...
**Branch:** RT-2018-rights-migration-grants
...
The progress in full — `docs/tasks/RT-2018-rights-migration-grants/progress.md`; the plan lies next to it.

### Uncommitted

```
 M docs/specs/message-bus/access-rights/spec.md
?? prisma/migrations/20260910100000_grant_rights_to_existing_accounts/
```

### Commits over the main branch

```
22791ed21 docs: заведена папка задачи RT-2018
```
