...
kind: pattern
rule: doc-style
description: Pattern of the doc-style rule. Load when writing any project prose — rules, specs, READMEs, code comments, commit bodies, PR descriptions. "Do" and "don't" examples for every wording agreement. Not for the structure of a spec — that is the spec-driven rule.
---
