...
- **State:** `этап-идёт`
- **Этап:** 1, 2 и 3 закрыты, впереди 4 — раскладка и тексты
- **Сделано:** этап 3. Сверка называет эпик, ветки которого в заявках не видно, и эпик, задачи
  которого кончились, а заявки от его ветки нет. Пробы — 4, приняты на нарушении.
- **Следующий шаг:** этап 4 — раскладка, привязки в компаньоне, затем сверка спеков и набор
  пакета целиком.
- **Незакоммиченное:** нет.
