...
- **State:** `этап-идёт`
- **Stage:** 4 of 4 — договорённость влита в спеку домена
- **Done:** этап 3 закрыт: проверка `tools/check-boolean-inputs.mjs` стоит в наборе перед push и в
  задании, набор сценариев над ней зелёный
- **Next step:** этап 4 — перенести правила и сценарии в спеку домена, снять папку `proposed/`
- **Uncommitted:** нет
