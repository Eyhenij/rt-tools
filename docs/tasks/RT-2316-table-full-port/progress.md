...
- **Next step:** договорённость переписывается под отдельный компонент с видом первого кита,
  номера сценариев остаются те же.
- **Uncommitted:** ничего.
- **Waiting for the owner:** нет. Образец радиокнопки владелец дал, она сделана.
- **PR:** not open yet
