...
- **Next step:** ответы владельца на открытые вопросы договорённости, затем план.
- **Uncommitted:** ничего.
- **Waiting for the owner:** имя семейства и открытые вопросы, где первый кит ведёт себя странно
  (Q-TP-10, 11, 16, 18); остальное решается правилом «как в первом».
- **PR:** not open yet
