<!-- rt-kit v0.23.0 · laws/verifiability.md · 7ecb4f8e413f · правится надстройкой, не здесь -->
...
- **Проверка, которая сама сломалась, работу не останавливает.** Отказ инструмента не считается
  найденным нарушением, и остановленная им работа стоит до того, как его починят. Ход отсюда один,
  и он называется в самом отказе: исполнитель разбирает отказ поимённо, показывает владельцу
  разбор — сколько строк, какого рода, чем доказана их ложность, — и чинит саму проверку. Список
  известного тут ни при чём: он копит принятое, а не показания сломанного прибора.
