<!-- rt-kit v0.10.0 · laws/work-conduct.md · f41ed2133e80 · правится надстройкой, не здесь -->
...
- **Заход исполнителя не кончается вместе с задачей.** Конец задачи — не признак остановки:
  ...
  под рукой.
- **Переход от одного состояния работы к другому исполнителя не останавливает.** Обязательное
