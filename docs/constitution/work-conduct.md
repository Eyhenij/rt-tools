<!-- rt-kit v0.23.0 · laws/work-conduct.md · 7ffe25e2999b · правится надстройкой, не здесь -->
...
- **Работа, которая требует изменений по образцу, начинается с чтения самого образца.** Пересказ
  образцом не является: расхождение всплывает на приёмке целой работой, а не строкой. Читается та
