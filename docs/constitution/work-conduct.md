<!-- rt-kit v0.23.0 · laws/work-conduct.md · cf15e40a3d4f · правится надстройкой, не здесь -->
...
- **Работа, которая требует изменений по образцу, начинается с чтения самого образца.** Пересказ
  образца образцом не считается: по нему собирается понимание того, кто пересказывал, и расхождение
...
- **Пустой вывод утверждением не бывает.** Он значит либо «ноль строк», либо «спрошено не то», и
  различает их только повторный вызов без конвейера и без глушения потока ошибок. Пока такой
  вызов не сделан, о дереве не сказано ничего, а «ничего нет» — самая дорогая ошибка: она отменяет
  работу, которую владелец велел сделать.
...
- **Инструмент, названный в просьбе, входит в просьбу.** Замена его на свой — отступление от
  ...
  Одинаковый результат равноценностью не считается — у названного инструмента бывает видно то,
