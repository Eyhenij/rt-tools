...
**Чем кончилась первая.** Задача RT-703, отчёт #709. Шесть статей стоят в законе о документации
...
**Чего эпик не сделал.** Владелец находки ещё не читал: девятнадцать расхождений и пробелов по
двум семьям лежат в `docs/plans/agent-kit-rules-review-findings.md` и ждут его слова. Пока оно не
сказано, наружу из них не уезжает ничего.
