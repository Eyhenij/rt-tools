...
Когда закрыты все четыре задачи и человек, закрепивший подменю, растянувший его и
перезагрузивший страницу, видит его по-прежнему закреплённым и той же ширины, а в отобранном
списке — отмеченным то, чем пункт совпал. Признак снимается в браузере, а не чтением кода.
