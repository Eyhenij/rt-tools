...
| Что                                                    | Сколько |
| ------------------------------------------------------ | ------- |
| Пиксельных литералов в стилях компонентов              | 213     |
| Кодов цвета там же                                     | 44      |
| Употребляемых и нигде не объявленных `--rt-*`          | 42      |
| Из них в `var()` без запасного значения                | 4       |
| Файлов, объявляющих свои свойства, из 78               | 13      |
...
Разбор просьбы — `docs/tasks/RT-381-tokens-spec-scope/grill.md`, договорённость о продукте —
`docs/specs/ui-kit-v2/proposed/design-tokens/`.
