...
| №   | Задача                                    | Почему здесь                                                                                      |
| --- | ----------------------------------------- | ------------------------------------------------------------------------------------------------- |
| 1   | Цена входа считается командой             | без числа ни одна следующая задача не докажет выигрыш                                             |
...
Снят 25 августа 2026 года командой счёта, на этом дереве. Считаны символы и байты — то, что
берётся на месте, без сети и без платы.
